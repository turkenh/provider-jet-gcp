...
var (
	SourceRepresentationInstanceKind             = "SourceRepresentationInstance"
	SourceRepresentationInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: SourceRepresentationInstanceKind}.String()
	SourceRepresentationInstanceKindAPIVersion   = SourceRepresentationInstanceKind + "." + GroupVersion.String()
	SourceRepresentationInstanceGroupVersionKind = GroupVersion.WithKind(SourceRepresentationInstanceKind)
)
