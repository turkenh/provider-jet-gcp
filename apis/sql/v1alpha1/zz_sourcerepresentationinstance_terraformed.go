...
// GetTerraformResourceIDField returns Terraform identifier field for this SourceRepresentationInstance
func (tr *SourceRepresentationInstance) GetTerraformResourceIDField() string {
	return "id"
}
