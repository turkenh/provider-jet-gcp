...
var (
	SslCertKind             = "SslCert"
	SslCertGroupKind        = schema.GroupKind{Group: Group, Kind: SslCertKind}.String()
	SslCertKindAPIVersion   = SslCertKind + "." + GroupVersion.String()
	SslCertGroupVersionKind = GroupVersion.WithKind(SslCertKind)
)
