...
var (
	DatabaseInstanceKind             = "DatabaseInstance"
	DatabaseInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: DatabaseInstanceKind}.String()
	DatabaseInstanceKindAPIVersion   = DatabaseInstanceKind + "." + GroupVersion.String()
	DatabaseInstanceGroupVersionKind = GroupVersion.WithKind(DatabaseInstanceKind)
)
