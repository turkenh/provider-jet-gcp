...
var (
	...
	DomainMappingGroupKind        = schema.GroupKind{Group: Group, Kind: DomainMappingKind}.String()
	DomainMappingKindAPIVersion   = DomainMappingKind + "." + GroupVersion.String()
	DomainMappingGroupVersionKind = GroupVersion.WithKind(DomainMappingKind)
)
