...
var (
	ServiceIamBindingKind             = "ServiceIamBinding"
	ServiceIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceIamBindingKind}.String()
	ServiceIamBindingKindAPIVersion   = ServiceIamBindingKind + "." + GroupVersion.String()
	ServiceIamBindingGroupVersionKind = GroupVersion.WithKind(ServiceIamBindingKind)
)
