...
var (
	ServiceIamPolicyKind             = "ServiceIamPolicy"
	ServiceIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceIamPolicyKind}.String()
	ServiceIamPolicyKindAPIVersion   = ServiceIamPolicyKind + "." + GroupVersion.String()
	ServiceIamPolicyGroupVersionKind = GroupVersion.WithKind(ServiceIamPolicyKind)
)
