...
var (
	ServiceIamMemberKind             = "ServiceIamMember"
	ServiceIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceIamMemberKind}.String()
	ServiceIamMemberKindAPIVersion   = ServiceIamMemberKind + "." + GroupVersion.String()
	ServiceIamMemberGroupVersionKind = GroupVersion.WithKind(ServiceIamMemberKind)
)
