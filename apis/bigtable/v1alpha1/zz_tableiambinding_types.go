...
var (
	TableIamBindingKind             = "TableIamBinding"
	TableIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TableIamBindingKind}.String()
	TableIamBindingKindAPIVersion   = TableIamBindingKind + "." + GroupVersion.String()
	TableIamBindingGroupVersionKind = GroupVersion.WithKind(TableIamBindingKind)
)
