...
var (
	GcPolicyKind             = "GcPolicy"
	GcPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: GcPolicyKind}.String()
	GcPolicyKindAPIVersion   = GcPolicyKind + "." + GroupVersion.String()
	GcPolicyGroupVersionKind = GroupVersion.WithKind(GcPolicyKind)
)
