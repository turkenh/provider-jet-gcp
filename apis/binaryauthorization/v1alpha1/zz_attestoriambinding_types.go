...
var (
	AttestorIamBindingKind             = "AttestorIamBinding"
	AttestorIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: AttestorIamBindingKind}.String()
	AttestorIamBindingKindAPIVersion   = AttestorIamBindingKind + "." + GroupVersion.String()
	AttestorIamBindingGroupVersionKind = GroupVersion.WithKind(AttestorIamBindingKind)
)
