...
var (
	AttestorIamPolicyKind             = "AttestorIamPolicy"
	AttestorIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AttestorIamPolicyKind}.String()
	AttestorIamPolicyKindAPIVersion   = AttestorIamPolicyKind + "." + GroupVersion.String()
	AttestorIamPolicyGroupVersionKind = GroupVersion.WithKind(AttestorIamPolicyKind)
)
