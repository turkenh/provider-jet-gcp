...
// GetTerraformResourceIDField returns Terraform identifier field for this AttestorIamBinding
func (tr *AttestorIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
