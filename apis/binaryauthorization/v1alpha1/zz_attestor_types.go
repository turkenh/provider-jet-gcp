...
var (
	AttestorKind             = "Attestor"
	AttestorGroupKind        = schema.GroupKind{Group: Group, Kind: AttestorKind}.String()
	AttestorKindAPIVersion   = AttestorKind + "." + GroupVersion.String()
	AttestorGroupVersionKind = GroupVersion.WithKind(AttestorKind)
)
