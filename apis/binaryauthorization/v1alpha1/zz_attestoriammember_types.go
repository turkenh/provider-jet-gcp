...
var (
	AttestorIamMemberKind             = "AttestorIamMember"
	AttestorIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: AttestorIamMemberKind}.String()
	AttestorIamMemberKindAPIVersion   = AttestorIamMemberKind + "." + GroupVersion.String()
	AttestorIamMemberGroupVersionKind = GroupVersion.WithKind(AttestorIamMemberKind)
)
