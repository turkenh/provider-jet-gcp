...
var (
	MetricDescriptorKind             = "MetricDescriptor"
	MetricDescriptorGroupKind        = schema.GroupKind{Group: Group, Kind: MetricDescriptorKind}.String()
	MetricDescriptorKindAPIVersion   = MetricDescriptorKind + "." + GroupVersion.String()
	MetricDescriptorGroupVersionKind = GroupVersion.WithKind(MetricDescriptorKind)
)
