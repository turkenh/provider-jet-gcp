...
var (
	UptimeCheckConfigKind             = "UptimeCheckConfig"
	UptimeCheckConfigGroupKind        = schema.GroupKind{Group: Group, Kind: UptimeCheckConfigKind}.String()
	UptimeCheckConfigKindAPIVersion   = UptimeCheckConfigKind + "." + GroupVersion.String()
	UptimeCheckConfigGroupVersionKind = GroupVersion.WithKind(UptimeCheckConfigKind)
)
