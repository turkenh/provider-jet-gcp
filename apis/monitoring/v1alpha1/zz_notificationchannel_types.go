...
var (
	...
	NotificationChannelKindAPIVersion   = NotificationChannelKind + "." + GroupVersion.String()
	NotificationChannelGroupVersionKind = GroupVersion.WithKind(NotificationChannelKind)
)
