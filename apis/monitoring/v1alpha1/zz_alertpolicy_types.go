...
var (
	AlertPolicyKind             = "AlertPolicy"
	AlertPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AlertPolicyKind}.String()
	AlertPolicyKindAPIVersion   = AlertPolicyKind + "." + GroupVersion.String()
	AlertPolicyGroupVersionKind = GroupVersion.WithKind(AlertPolicyKind)
)
