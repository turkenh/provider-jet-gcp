...
var (
	CustomServiceKind             = "CustomService"
	CustomServiceGroupKind        = schema.GroupKind{Group: Group, Kind: CustomServiceKind}.String()
	CustomServiceKindAPIVersion   = CustomServiceKind + "." + GroupVersion.String()
	CustomServiceGroupVersionKind = GroupVersion.WithKind(CustomServiceKind)
)
