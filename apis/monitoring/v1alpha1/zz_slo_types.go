...
var (
	SloKind             = "Slo"
	SloGroupKind        = schema.GroupKind{Group: Group, Kind: SloKind}.String()
	SloKindAPIVersion   = SloKind + "." + GroupVersion.String()
	SloGroupVersionKind = GroupVersion.WithKind(SloKind)
)
