...
var (
	JobIamMemberKind             = "JobIamMember"
	JobIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: JobIamMemberKind}.String()
	JobIamMemberKindAPIVersion   = JobIamMemberKind + "." + GroupVersion.String()
	JobIamMemberGroupVersionKind = GroupVersion.WithKind(JobIamMemberKind)
)
