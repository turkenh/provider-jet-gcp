...
var (
	ClusterIamBindingKind             = "ClusterIamBinding"
	ClusterIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterIamBindingKind}.String()
	ClusterIamBindingKindAPIVersion   = ClusterIamBindingKind + "." + GroupVersion.String()
	ClusterIamBindingGroupVersionKind = GroupVersion.WithKind(ClusterIamBindingKind)
)
