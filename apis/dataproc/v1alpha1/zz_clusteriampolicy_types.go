...
var (
	ClusterIamPolicyKind             = "ClusterIamPolicy"
	ClusterIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterIamPolicyKind}.String()
	ClusterIamPolicyKindAPIVersion   = ClusterIamPolicyKind + "." + GroupVersion.String()
	ClusterIamPolicyGroupVersionKind = GroupVersion.WithKind(ClusterIamPolicyKind)
)
