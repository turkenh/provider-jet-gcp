...
var (
	ClusterIamMemberKind             = "ClusterIamMember"
	ClusterIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterIamMemberKind}.String()
	ClusterIamMemberKindAPIVersion   = ClusterIamMemberKind + "." + GroupVersion.String()
	ClusterIamMemberGroupVersionKind = GroupVersion.WithKind(ClusterIamMemberKind)
)
