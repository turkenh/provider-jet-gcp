...
var (
	JobIamBindingKind             = "JobIamBinding"
	JobIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: JobIamBindingKind}.String()
	JobIamBindingKindAPIVersion   = JobIamBindingKind + "." + GroupVersion.String()
	JobIamBindingGroupVersionKind = GroupVersion.WithKind(JobIamBindingKind)
)
