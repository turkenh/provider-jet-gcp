...
var (
	FunctionIamBindingKind             = "FunctionIamBinding"
	FunctionIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: FunctionIamBindingKind}.String()
	FunctionIamBindingKindAPIVersion   = FunctionIamBindingKind + "." + GroupVersion.String()
	FunctionIamBindingGroupVersionKind = GroupVersion.WithKind(FunctionIamBindingKind)
)
