...
var (
	FunctionIamMemberKind             = "FunctionIamMember"
	FunctionIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: FunctionIamMemberKind}.String()
	FunctionIamMemberKindAPIVersion   = FunctionIamMemberKind + "." + GroupVersion.String()
	FunctionIamMemberGroupVersionKind = GroupVersion.WithKind(FunctionIamMemberKind)
)
