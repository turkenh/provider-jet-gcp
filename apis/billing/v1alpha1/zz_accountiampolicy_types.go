...
var (
	AccountIamPolicyKind             = "AccountIamPolicy"
	AccountIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AccountIamPolicyKind}.String()
	AccountIamPolicyKindAPIVersion   = AccountIamPolicyKind + "." + GroupVersion.String()
	AccountIamPolicyGroupVersionKind = GroupVersion.WithKind(AccountIamPolicyKind)
)
