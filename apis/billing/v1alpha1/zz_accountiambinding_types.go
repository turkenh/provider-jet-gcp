...
var (
	AccountIamBindingKind             = "AccountIamBinding"
	AccountIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: AccountIamBindingKind}.String()
	AccountIamBindingKindAPIVersion   = AccountIamBindingKind + "." + GroupVersion.String()
	AccountIamBindingGroupVersionKind = GroupVersion.WithKind(AccountIamBindingKind)
)
