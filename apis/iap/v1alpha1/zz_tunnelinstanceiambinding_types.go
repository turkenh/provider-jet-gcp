...
var (
	TunnelInstanceIamBindingKind             = "TunnelInstanceIamBinding"
	TunnelInstanceIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TunnelInstanceIamBindingKind}.String()
	TunnelInstanceIamBindingKindAPIVersion   = TunnelInstanceIamBindingKind + "." + GroupVersion.String()
	TunnelInstanceIamBindingGroupVersionKind = GroupVersion.WithKind(TunnelInstanceIamBindingKind)
)
