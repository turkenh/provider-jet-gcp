...
// GetTerraformResourceIDField returns Terraform identifier field for this AppEngineServiceIamBinding
func (tr *AppEngineServiceIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
