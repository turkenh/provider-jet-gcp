...
var (
	TunnelIamPolicyKind             = "TunnelIamPolicy"
	TunnelIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TunnelIamPolicyKind}.String()
	TunnelIamPolicyKindAPIVersion   = TunnelIamPolicyKind + "." + GroupVersion.String()
	TunnelIamPolicyGroupVersionKind = GroupVersion.WithKind(TunnelIamPolicyKind)
)
