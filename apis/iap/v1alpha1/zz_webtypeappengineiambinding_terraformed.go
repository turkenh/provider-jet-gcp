...
// GetTerraformResourceIDField returns Terraform identifier field for this WebTypeAppEngineIamBinding
func (tr *WebTypeAppEngineIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
