...
var (
	WebIamMemberKind             = "WebIamMember"
	WebIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: WebIamMemberKind}.String()
	WebIamMemberKindAPIVersion   = WebIamMemberKind + "." + GroupVersion.String()
	WebIamMemberGroupVersionKind = GroupVersion.WithKind(WebIamMemberKind)
)
