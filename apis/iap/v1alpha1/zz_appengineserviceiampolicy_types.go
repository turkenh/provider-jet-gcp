...
var (
	AppEngineServiceIamPolicyKind             = "AppEngineServiceIamPolicy"
	AppEngineServiceIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AppEngineServiceIamPolicyKind}.String()
	AppEngineServiceIamPolicyKindAPIVersion   = AppEngineServiceIamPolicyKind + "." + GroupVersion.String()
	AppEngineServiceIamPolicyGroupVersionKind = GroupVersion.WithKind(AppEngineServiceIamPolicyKind)
)
