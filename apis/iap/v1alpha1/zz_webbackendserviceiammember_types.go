...
var (
	WebBackendServiceIamMemberKind             = "WebBackendServiceIamMember"
	WebBackendServiceIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: WebBackendServiceIamMemberKind}.String()
	WebBackendServiceIamMemberKindAPIVersion   = WebBackendServiceIamMemberKind + "." + GroupVersion.String()
	WebBackendServiceIamMemberGroupVersionKind = GroupVersion.WithKind(WebBackendServiceIamMemberKind)
)
