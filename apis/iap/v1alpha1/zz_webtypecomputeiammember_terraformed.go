...
// GetTerraformResourceIDField returns Terraform identifier field for this WebTypeComputeIamMember
func (tr *WebTypeComputeIamMember) GetTerraformResourceIDField() string {
	return "id"
}
