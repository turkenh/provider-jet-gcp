...
var (
	BrandKind             = "Brand"
	BrandGroupKind        = schema.GroupKind{Group: Group, Kind: BrandKind}.String()
	BrandKindAPIVersion   = BrandKind + "." + GroupVersion.String()
	BrandGroupVersionKind = GroupVersion.WithKind(BrandKind)
)
