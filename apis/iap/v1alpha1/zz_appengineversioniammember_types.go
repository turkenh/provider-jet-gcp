...
var (
	AppEngineVersionIamMemberKind             = "AppEngineVersionIamMember"
	AppEngineVersionIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: AppEngineVersionIamMemberKind}.String()
	AppEngineVersionIamMemberKindAPIVersion   = AppEngineVersionIamMemberKind + "." + GroupVersion.String()
	AppEngineVersionIamMemberGroupVersionKind = GroupVersion.WithKind(AppEngineVersionIamMemberKind)
)
