...
// GetTerraformResourceIDField returns Terraform identifier field for this AppEngineVersionIamPolicy
func (tr *AppEngineVersionIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
