...
var (
	WebTypeAppEngineIamPolicyKind             = "WebTypeAppEngineIamPolicy"
	WebTypeAppEngineIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeAppEngineIamPolicyKind}.String()
	WebTypeAppEngineIamPolicyKindAPIVersion   = WebTypeAppEngineIamPolicyKind + "." + GroupVersion.String()
	WebTypeAppEngineIamPolicyGroupVersionKind = GroupVersion.WithKind(WebTypeAppEngineIamPolicyKind)
)
