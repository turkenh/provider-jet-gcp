...
// GetTerraformResourceIDField returns Terraform identifier field for this WebTypeComputeIamPolicy
func (tr *WebTypeComputeIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
