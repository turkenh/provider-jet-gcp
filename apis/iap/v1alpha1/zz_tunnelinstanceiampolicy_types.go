...
var (
	TunnelInstanceIamPolicyKind             = "TunnelInstanceIamPolicy"
	TunnelInstanceIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TunnelInstanceIamPolicyKind}.String()
	TunnelInstanceIamPolicyKindAPIVersion   = TunnelInstanceIamPolicyKind + "." + GroupVersion.String()
	TunnelInstanceIamPolicyGroupVersionKind = GroupVersion.WithKind(TunnelInstanceIamPolicyKind)
)
