...
var (
	WebBackendServiceIamPolicyKind             = "WebBackendServiceIamPolicy"
	WebBackendServiceIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WebBackendServiceIamPolicyKind}.String()
	WebBackendServiceIamPolicyKindAPIVersion   = WebBackendServiceIamPolicyKind + "." + GroupVersion.String()
	WebBackendServiceIamPolicyGroupVersionKind = GroupVersion.WithKind(WebBackendServiceIamPolicyKind)
)
