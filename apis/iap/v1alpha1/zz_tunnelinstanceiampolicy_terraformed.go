...
// GetTerraformResourceIDField returns Terraform identifier field for this TunnelInstanceIamPolicy
func (tr *TunnelInstanceIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
