...
// GetTerraformResourceIDField returns Terraform identifier field for this WebTypeAppEngineIamPolicy
func (tr *WebTypeAppEngineIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
