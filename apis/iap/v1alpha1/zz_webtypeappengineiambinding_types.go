...
var (
	WebTypeAppEngineIamBindingKind             = "WebTypeAppEngineIamBinding"
	WebTypeAppEngineIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeAppEngineIamBindingKind}.String()
	WebTypeAppEngineIamBindingKindAPIVersion   = WebTypeAppEngineIamBindingKind + "." + GroupVersion.String()
	WebTypeAppEngineIamBindingGroupVersionKind = GroupVersion.WithKind(WebTypeAppEngineIamBindingKind)
)
