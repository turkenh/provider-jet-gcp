...
// GetTerraformResourceIDField returns Terraform identifier field for this TunnelInstanceIamBinding
func (tr *TunnelInstanceIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
