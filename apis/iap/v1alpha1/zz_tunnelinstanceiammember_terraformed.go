...
// GetTerraformResourceIDField returns Terraform identifier field for this TunnelInstanceIamMember
func (tr *TunnelInstanceIamMember) GetTerraformResourceIDField() string {
	return "id"
}
