...
// GetTerraformResourceIDField returns Terraform identifier field for this WebBackendServiceIamBinding
func (tr *WebBackendServiceIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
