...
// GetTerraformResourceIDField returns Terraform identifier field for this AppEngineVersionIamBinding
func (tr *AppEngineVersionIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
