...
var (
	TunnelIamBindingKind             = "TunnelIamBinding"
	TunnelIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TunnelIamBindingKind}.String()
	TunnelIamBindingKindAPIVersion   = TunnelIamBindingKind + "." + GroupVersion.String()
	TunnelIamBindingGroupVersionKind = GroupVersion.WithKind(TunnelIamBindingKind)
)
