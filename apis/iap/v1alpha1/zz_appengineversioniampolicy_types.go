...
var (
	AppEngineVersionIamPolicyKind             = "AppEngineVersionIamPolicy"
	AppEngineVersionIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AppEngineVersionIamPolicyKind}.String()
	AppEngineVersionIamPolicyKindAPIVersion   = AppEngineVersionIamPolicyKind + "." + GroupVersion.String()
	AppEngineVersionIamPolicyGroupVersionKind = GroupVersion.WithKind(AppEngineVersionIamPolicyKind)
)
