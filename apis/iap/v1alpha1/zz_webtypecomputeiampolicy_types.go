...
var (
	WebTypeComputeIamPolicyKind             = "WebTypeComputeIamPolicy"
	WebTypeComputeIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeComputeIamPolicyKind}.String()
	WebTypeComputeIamPolicyKindAPIVersion   = WebTypeComputeIamPolicyKind + "." + GroupVersion.String()
	WebTypeComputeIamPolicyGroupVersionKind = GroupVersion.WithKind(WebTypeComputeIamPolicyKind)
)
