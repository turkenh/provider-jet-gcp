...
// GetTerraformResourceIDField returns Terraform identifier field for this WebTypeComputeIamBinding
func (tr *WebTypeComputeIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
