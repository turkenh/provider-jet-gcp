...
var (
	WebBackendServiceIamBindingKind             = "WebBackendServiceIamBinding"
	WebBackendServiceIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: WebBackendServiceIamBindingKind}.String()
	WebBackendServiceIamBindingKindAPIVersion   = WebBackendServiceIamBindingKind + "." + GroupVersion.String()
	WebBackendServiceIamBindingGroupVersionKind = GroupVersion.WithKind(WebBackendServiceIamBindingKind)
)
