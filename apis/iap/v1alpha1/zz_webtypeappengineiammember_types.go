...
var (
	WebTypeAppEngineIamMemberKind             = "WebTypeAppEngineIamMember"
	WebTypeAppEngineIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeAppEngineIamMemberKind}.String()
	WebTypeAppEngineIamMemberKindAPIVersion   = WebTypeAppEngineIamMemberKind + "." + GroupVersion.String()
	WebTypeAppEngineIamMemberGroupVersionKind = GroupVersion.WithKind(WebTypeAppEngineIamMemberKind)
)
