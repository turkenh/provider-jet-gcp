...
var (
	WebIamBindingKind             = "WebIamBinding"
	WebIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: WebIamBindingKind}.String()
	WebIamBindingKindAPIVersion   = WebIamBindingKind + "." + GroupVersion.String()
	WebIamBindingGroupVersionKind = GroupVersion.WithKind(WebIamBindingKind)
)
