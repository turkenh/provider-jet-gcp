...
var (
	WebTypeComputeIamBindingKind             = "WebTypeComputeIamBinding"
	WebTypeComputeIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeComputeIamBindingKind}.String()
	WebTypeComputeIamBindingKindAPIVersion   = WebTypeComputeIamBindingKind + "." + GroupVersion.String()
	WebTypeComputeIamBindingGroupVersionKind = GroupVersion.WithKind(WebTypeComputeIamBindingKind)
)
