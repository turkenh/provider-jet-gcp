...
var (
	WebTypeComputeIamMemberKind             = "WebTypeComputeIamMember"
	WebTypeComputeIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: WebTypeComputeIamMemberKind}.String()
	WebTypeComputeIamMemberKindAPIVersion   = WebTypeComputeIamMemberKind + "." + GroupVersion.String()
	WebTypeComputeIamMemberGroupVersionKind = GroupVersion.WithKind(WebTypeComputeIamMemberKind)
)
