...
// GetTerraformResourceIDField returns Terraform identifier field for this WebBackendServiceIamPolicy
func (tr *WebBackendServiceIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
