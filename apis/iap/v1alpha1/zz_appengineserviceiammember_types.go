...
var (
	AppEngineServiceIamMemberKind             = "AppEngineServiceIamMember"
	AppEngineServiceIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: AppEngineServiceIamMemberKind}.String()
	AppEngineServiceIamMemberKindAPIVersion   = AppEngineServiceIamMemberKind + "." + GroupVersion.String()
	AppEngineServiceIamMemberGroupVersionKind = GroupVersion.WithKind(AppEngineServiceIamMemberKind)
)
