...
var (
	WebIamPolicyKind             = "WebIamPolicy"
	WebIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: WebIamPolicyKind}.String()
	WebIamPolicyKindAPIVersion   = WebIamPolicyKind + "." + GroupVersion.String()
	WebIamPolicyGroupVersionKind = GroupVersion.WithKind(WebIamPolicyKind)
)
