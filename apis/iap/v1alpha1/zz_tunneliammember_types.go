...
var (
	TunnelIamMemberKind             = "TunnelIamMember"
	TunnelIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TunnelIamMemberKind}.String()
	TunnelIamMemberKindAPIVersion   = TunnelIamMemberKind + "." + GroupVersion.String()
	TunnelIamMemberGroupVersionKind = GroupVersion.WithKind(TunnelIamMemberKind)
)
