...
// GetTerraformResourceIDField returns Terraform identifier field for this RepositoryIamMember
func (tr *RepositoryIamMember) GetTerraformResourceIDField() string {
	return "id"
}
