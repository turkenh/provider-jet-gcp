...
var (
	RepositoryIamMemberKind             = "RepositoryIamMember"
	RepositoryIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: RepositoryIamMemberKind}.String()
	RepositoryIamMemberKindAPIVersion   = RepositoryIamMemberKind + "." + GroupVersion.String()
	RepositoryIamMemberGroupVersionKind = GroupVersion.WithKind(RepositoryIamMemberKind)
)
