...
var (
	RepositoryIamPolicyKind             = "RepositoryIamPolicy"
	RepositoryIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: RepositoryIamPolicyKind}.String()
	RepositoryIamPolicyKindAPIVersion   = RepositoryIamPolicyKind + "." + GroupVersion.String()
	RepositoryIamPolicyGroupVersionKind = GroupVersion.WithKind(RepositoryIamPolicyKind)
)
