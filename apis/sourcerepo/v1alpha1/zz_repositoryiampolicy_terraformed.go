...
// GetTerraformResourceIDField returns Terraform identifier field for this RepositoryIamPolicy
func (tr *RepositoryIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
