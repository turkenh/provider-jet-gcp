...
var (
	RepositoryIamBindingKind             = "RepositoryIamBinding"
	RepositoryIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: RepositoryIamBindingKind}.String()
	RepositoryIamBindingKindAPIVersion   = RepositoryIamBindingKind + "." + GroupVersion.String()
	RepositoryIamBindingGroupVersionKind = GroupVersion.WithKind(RepositoryIamBindingKind)
)
