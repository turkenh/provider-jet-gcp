...
// GetTerraformResourceIDField returns Terraform identifier field for this RepositoryIamBinding
func (tr *RepositoryIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
