...
var (
	DomainTrustKind             = "DomainTrust"
	DomainTrustGroupKind        = schema.GroupKind{Group: Group, Kind: DomainTrustKind}.String()
	DomainTrustKindAPIVersion   = DomainTrustKind + "." + GroupVersion.String()
	DomainTrustGroupVersionKind = GroupVersion.WithKind(DomainTrustKind)
)
