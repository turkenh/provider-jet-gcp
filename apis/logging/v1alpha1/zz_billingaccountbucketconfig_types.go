...
var (
	BillingAccountBucketConfigKind             = "BillingAccountBucketConfig"
	BillingAccountBucketConfigGroupKind        = schema.GroupKind{Group: Group, Kind: BillingAccountBucketConfigKind}.String()
	BillingAccountBucketConfigKindAPIVersion   = BillingAccountBucketConfigKind + "." + GroupVersion.String()
	BillingAccountBucketConfigGroupVersionKind = GroupVersion.WithKind(BillingAccountBucketConfigKind)
)
