...
var (
	ProjectExclusionKind             = "ProjectExclusion"
	ProjectExclusionGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectExclusionKind}.String()
	ProjectExclusionKindAPIVersion   = ProjectExclusionKind + "." + GroupVersion.String()
	ProjectExclusionGroupVersionKind = GroupVersion.WithKind(ProjectExclusionKind)
)
