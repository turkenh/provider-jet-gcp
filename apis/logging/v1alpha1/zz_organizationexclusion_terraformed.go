...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationExclusion
func (tr *OrganizationExclusion) GetTerraformResourceIDField() string {
	return "id"
}
