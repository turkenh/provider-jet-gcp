...
var (
	ProjectSinkKind             = "ProjectSink"
	ProjectSinkGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectSinkKind}.String()
	ProjectSinkKindAPIVersion   = ProjectSinkKind + "." + GroupVersion.String()
	ProjectSinkGroupVersionKind = GroupVersion.WithKind(ProjectSinkKind)
)
