...
var (
	FolderSinkKind             = "FolderSink"
	FolderSinkGroupKind        = schema.GroupKind{Group: Group, Kind: FolderSinkKind}.String()
	FolderSinkKindAPIVersion   = FolderSinkKind + "." + GroupVersion.String()
	FolderSinkGroupVersionKind = GroupVersion.WithKind(FolderSinkKind)
)
