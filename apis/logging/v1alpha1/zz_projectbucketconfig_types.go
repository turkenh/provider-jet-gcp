...
var (
	ProjectBucketConfigKind             = "ProjectBucketConfig"
	ProjectBucketConfigGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectBucketConfigKind}.String()
	ProjectBucketConfigKindAPIVersion   = ProjectBucketConfigKind + "." + GroupVersion.String()
	ProjectBucketConfigGroupVersionKind = GroupVersion.WithKind(ProjectBucketConfigKind)
)
