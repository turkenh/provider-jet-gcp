...
var (
	OrganizationBucketConfigKind             = "OrganizationBucketConfig"
	OrganizationBucketConfigGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationBucketConfigKind}.String()
	OrganizationBucketConfigKindAPIVersion   = OrganizationBucketConfigKind + "." + GroupVersion.String()
	OrganizationBucketConfigGroupVersionKind = GroupVersion.WithKind(OrganizationBucketConfigKind)
)
