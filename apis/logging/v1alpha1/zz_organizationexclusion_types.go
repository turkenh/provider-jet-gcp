...
var (
	OrganizationExclusionKind             = "OrganizationExclusion"
	OrganizationExclusionGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationExclusionKind}.String()
	OrganizationExclusionKindAPIVersion   = OrganizationExclusionKind + "." + GroupVersion.String()
	OrganizationExclusionGroupVersionKind = GroupVersion.WithKind(OrganizationExclusionKind)
)
