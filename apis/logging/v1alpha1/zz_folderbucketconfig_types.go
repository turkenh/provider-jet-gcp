...
var (
	FolderBucketConfigKind             = "FolderBucketConfig"
	FolderBucketConfigGroupKind        = schema.GroupKind{Group: Group, Kind: FolderBucketConfigKind}.String()
	FolderBucketConfigKindAPIVersion   = FolderBucketConfigKind + "." + GroupVersion.String()
	FolderBucketConfigGroupVersionKind = GroupVersion.WithKind(FolderBucketConfigKind)
)
