...
// GetTerraformResourceIDField returns Terraform identifier field for this BillingAccountBucketConfig
func (tr *BillingAccountBucketConfig) GetTerraformResourceIDField() string {
	return "id"
}
