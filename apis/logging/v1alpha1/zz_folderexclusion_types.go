...
var (
	FolderExclusionKind             = "FolderExclusion"
	FolderExclusionGroupKind        = schema.GroupKind{Group: Group, Kind: FolderExclusionKind}.String()
	FolderExclusionKindAPIVersion   = FolderExclusionKind + "." + GroupVersion.String()
	FolderExclusionGroupVersionKind = GroupVersion.WithKind(FolderExclusionKind)
)
