...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectBucketConfig
func (tr *ProjectBucketConfig) GetTerraformResourceIDField() string {
	return "id"
}
