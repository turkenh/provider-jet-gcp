...
var (
	MetricKind             = "Metric"
	MetricGroupKind        = schema.GroupKind{Group: Group, Kind: MetricKind}.String()
	MetricKindAPIVersion   = MetricKind + "." + GroupVersion.String()
	MetricGroupVersionKind = GroupVersion.WithKind(MetricKind)
)
