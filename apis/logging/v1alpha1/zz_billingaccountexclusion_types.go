...
var (
	BillingAccountExclusionKind             = "BillingAccountExclusion"
	BillingAccountExclusionGroupKind        = schema.GroupKind{Group: Group, Kind: BillingAccountExclusionKind}.String()
	BillingAccountExclusionKindAPIVersion   = BillingAccountExclusionKind + "." + GroupVersion.String()
	BillingAccountExclusionGroupVersionKind = GroupVersion.WithKind(BillingAccountExclusionKind)
)
