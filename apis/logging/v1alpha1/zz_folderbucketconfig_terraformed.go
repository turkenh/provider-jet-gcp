...
// GetTerraformResourceIDField returns Terraform identifier field for this FolderBucketConfig
func (tr *FolderBucketConfig) GetTerraformResourceIDField() string {
	return "id"
}
