...
// GetTerraformResourceIDField returns Terraform identifier field for this BillingAccountExclusion
func (tr *BillingAccountExclusion) GetTerraformResourceIDField() string {
	return "id"
}
