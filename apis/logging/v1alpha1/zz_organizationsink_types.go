...
var (
	OrganizationSinkKind             = "OrganizationSink"
	OrganizationSinkGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationSinkKind}.String()
	OrganizationSinkKindAPIVersion   = OrganizationSinkKind + "." + GroupVersion.String()
	OrganizationSinkGroupVersionKind = GroupVersion.WithKind(OrganizationSinkKind)
)
