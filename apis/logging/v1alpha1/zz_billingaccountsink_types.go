...
var (
	BillingAccountSinkKind             = "BillingAccountSink"
	BillingAccountSinkGroupKind        = schema.GroupKind{Group: Group, Kind: BillingAccountSinkKind}.String()
	BillingAccountSinkKindAPIVersion   = BillingAccountSinkKind + "." + GroupVersion.String()
	BillingAccountSinkGroupVersionKind = GroupVersion.WithKind(BillingAccountSinkKind)
)
