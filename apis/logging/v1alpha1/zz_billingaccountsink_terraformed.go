...
// GetTerraformResourceIDField returns Terraform identifier field for this BillingAccountSink
func (tr *BillingAccountSink) GetTerraformResourceIDField() string {
	return "id"
}
