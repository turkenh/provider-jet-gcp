...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationBucketConfig
func (tr *OrganizationBucketConfig) GetTerraformResourceIDField() string {
	return "id"
}
