...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectOrganizationPolicy
func (tr *ProjectOrganizationPolicy) GetTerraformResourceIDField() string {
	return "id"
}
