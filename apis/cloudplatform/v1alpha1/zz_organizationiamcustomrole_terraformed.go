...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationIAMCustomRole
func (tr *OrganizationIAMCustomRole) GetTerraformResourceIDField() string {
	return "id"
}
