...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationIAMMember
func (tr *OrganizationIAMMember) GetTerraformResourceIDField() string {
	return "id"
}
