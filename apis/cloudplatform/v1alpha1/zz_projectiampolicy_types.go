...
var (
	ProjectIAMPolicyKind             = "ProjectIAMPolicy"
	ProjectIAMPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectIAMPolicyKind}.String()
	ProjectIAMPolicyKindAPIVersion   = ProjectIAMPolicyKind + "." + GroupVersion.String()
	ProjectIAMPolicyGroupVersionKind = GroupVersion.WithKind(ProjectIAMPolicyKind)
)
