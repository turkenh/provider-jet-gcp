...
var (
	OrganizationIAMBindingKind             = "OrganizationIAMBinding"
	OrganizationIAMBindingGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationIAMBindingKind}.String()
	OrganizationIAMBindingKindAPIVersion   = OrganizationIAMBindingKind + "." + GroupVersion.String()
	OrganizationIAMBindingGroupVersionKind = GroupVersion.WithKind(OrganizationIAMBindingKind)
)
