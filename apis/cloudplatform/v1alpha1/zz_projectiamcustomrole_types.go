...
var (
	ProjectIAMCustomRoleKind             = "ProjectIAMCustomRole"
	ProjectIAMCustomRoleGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectIAMCustomRoleKind}.String()
	ProjectIAMCustomRoleKindAPIVersion   = ProjectIAMCustomRoleKind + "." + GroupVersion.String()
	ProjectIAMCustomRoleGroupVersionKind = GroupVersion.WithKind(ProjectIAMCustomRoleKind)
)
