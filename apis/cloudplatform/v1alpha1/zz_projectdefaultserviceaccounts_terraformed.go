...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectDefaultServiceAccounts
func (tr *ProjectDefaultServiceAccounts) GetTerraformResourceIDField() string {
	return "id"
}
