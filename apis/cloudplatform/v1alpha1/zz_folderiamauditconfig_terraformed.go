...
// GetTerraformResourceIDField returns Terraform identifier field for this FolderIAMAuditConfig
func (tr *FolderIAMAuditConfig) GetTerraformResourceIDField() string {
	return "id"
}
