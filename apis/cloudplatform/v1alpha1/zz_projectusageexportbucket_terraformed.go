...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectUsageExportBucket
func (tr *ProjectUsageExportBucket) GetTerraformResourceIDField() string {
	return "id"
}
