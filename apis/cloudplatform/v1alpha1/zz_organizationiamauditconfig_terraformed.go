...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationIAMAuditConfig
func (tr *OrganizationIAMAuditConfig) GetTerraformResourceIDField() string {
	return "id"
}
