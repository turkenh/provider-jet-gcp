...
// GetTerraformResourceIDField returns Terraform identifier field for this FolderOrganizationPolicy
func (tr *FolderOrganizationPolicy) GetTerraformResourceIDField() string {
	return "id"
}
