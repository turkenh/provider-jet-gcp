...
var (
	FolderIAMBindingKind             = "FolderIAMBinding"
	FolderIAMBindingGroupKind        = schema.GroupKind{Group: Group, Kind: FolderIAMBindingKind}.String()
	FolderIAMBindingKindAPIVersion   = FolderIAMBindingKind + "." + GroupVersion.String()
	FolderIAMBindingGroupVersionKind = GroupVersion.WithKind(FolderIAMBindingKind)
)
