...
var (
	ProjectIAMBindingKind             = "ProjectIAMBinding"
	ProjectIAMBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectIAMBindingKind}.String()
	ProjectIAMBindingKindAPIVersion   = ProjectIAMBindingKind + "." + GroupVersion.String()
	ProjectIAMBindingGroupVersionKind = GroupVersion.WithKind(ProjectIAMBindingKind)
)
