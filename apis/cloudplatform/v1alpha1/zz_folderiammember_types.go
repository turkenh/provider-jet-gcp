...
var (
	FolderIAMMemberKind             = "FolderIAMMember"
	FolderIAMMemberGroupKind        = schema.GroupKind{Group: Group, Kind: FolderIAMMemberKind}.String()
	FolderIAMMemberKindAPIVersion   = FolderIAMMemberKind + "." + GroupVersion.String()
	FolderIAMMemberGroupVersionKind = GroupVersion.WithKind(FolderIAMMemberKind)
)
