...
var (
	ProjectUsageExportBucketKind             = "ProjectUsageExportBucket"
	ProjectUsageExportBucketGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectUsageExportBucketKind}.String()
	ProjectUsageExportBucketKindAPIVersion   = ProjectUsageExportBucketKind + "." + GroupVersion.String()
	ProjectUsageExportBucketGroupVersionKind = GroupVersion.WithKind(ProjectUsageExportBucketKind)
)
