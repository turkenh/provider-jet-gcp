...
var (
	ProjectDefaultServiceAccountsKind             = "ProjectDefaultServiceAccounts"
	ProjectDefaultServiceAccountsGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectDefaultServiceAccountsKind}.String()
	ProjectDefaultServiceAccountsKindAPIVersion   = ProjectDefaultServiceAccountsKind + "." + GroupVersion.String()
	ProjectDefaultServiceAccountsGroupVersionKind = GroupVersion.WithKind(ProjectDefaultServiceAccountsKind)
)
