...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectIAMAuditConfig
func (tr *ProjectIAMAuditConfig) GetTerraformResourceIDField() string {
	return "id"
}
