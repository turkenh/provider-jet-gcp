...
var (
	OrganizationIAMMemberKind             = "OrganizationIAMMember"
	OrganizationIAMMemberGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationIAMMemberKind}.String()
	OrganizationIAMMemberKindAPIVersion   = OrganizationIAMMemberKind + "." + GroupVersion.String()
	OrganizationIAMMemberGroupVersionKind = GroupVersion.WithKind(OrganizationIAMMemberKind)
)
