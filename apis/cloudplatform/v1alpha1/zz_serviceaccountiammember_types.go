...
var (
	ServiceAccountIAMMemberKind             = "ServiceAccountIAMMember"
	ServiceAccountIAMMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceAccountIAMMemberKind}.String()
	ServiceAccountIAMMemberKindAPIVersion   = ServiceAccountIAMMemberKind + "." + GroupVersion.String()
	ServiceAccountIAMMemberGroupVersionKind = GroupVersion.WithKind(ServiceAccountIAMMemberKind)
)
