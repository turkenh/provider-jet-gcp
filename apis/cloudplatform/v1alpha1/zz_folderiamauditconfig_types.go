...
var (
	FolderIAMAuditConfigKind             = "FolderIAMAuditConfig"
	FolderIAMAuditConfigGroupKind        = schema.GroupKind{Group: Group, Kind: FolderIAMAuditConfigKind}.String()
	FolderIAMAuditConfigKindAPIVersion   = FolderIAMAuditConfigKind + "." + GroupVersion.String()
	FolderIAMAuditConfigGroupVersionKind = GroupVersion.WithKind(FolderIAMAuditConfigKind)
)
