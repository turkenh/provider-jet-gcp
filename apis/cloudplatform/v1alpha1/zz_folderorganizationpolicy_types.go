...
var (
	FolderOrganizationPolicyKind             = "FolderOrganizationPolicy"
	FolderOrganizationPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: FolderOrganizationPolicyKind}.String()
	FolderOrganizationPolicyKindAPIVersion   = FolderOrganizationPolicyKind + "." + GroupVersion.String()
	FolderOrganizationPolicyGroupVersionKind = GroupVersion.WithKind(FolderOrganizationPolicyKind)
)
