...
var (
	ServiceAccountKeyKind             = "ServiceAccountKey"
	ServiceAccountKeyGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceAccountKeyKind}.String()
	ServiceAccountKeyKindAPIVersion   = ServiceAccountKeyKind + "." + GroupVersion.String()
	ServiceAccountKeyGroupVersionKind = GroupVersion.WithKind(ServiceAccountKeyKind)
)
