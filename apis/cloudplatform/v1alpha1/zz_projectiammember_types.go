...
var (
	ProjectIAMMemberKind             = "ProjectIAMMember"
	ProjectIAMMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectIAMMemberKind}.String()
	ProjectIAMMemberKindAPIVersion   = ProjectIAMMemberKind + "." + GroupVersion.String()
	ProjectIAMMemberGroupVersionKind = GroupVersion.WithKind(ProjectIAMMemberKind)
)
