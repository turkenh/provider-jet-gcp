...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationIAMPolicy
func (tr *OrganizationIAMPolicy) GetTerraformResourceIDField() string {
	return "id"
}
