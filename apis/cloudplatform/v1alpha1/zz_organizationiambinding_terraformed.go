...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationIAMBinding
func (tr *OrganizationIAMBinding) GetTerraformResourceIDField() string {
	return "id"
}
