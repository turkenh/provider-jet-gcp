...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectIAMCustomRole
func (tr *ProjectIAMCustomRole) GetTerraformResourceIDField() string {
	return "id"
}
