...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationPolicy
func (tr *OrganizationPolicy) GetTerraformResourceIDField() string {
	return "id"
}
