...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceAccountIAMBinding
func (tr *ServiceAccountIAMBinding) GetTerraformResourceIDField() string {
	return "id"
}
