...
var (
	OrganizationPolicyKind             = "OrganizationPolicy"
	OrganizationPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationPolicyKind}.String()
	OrganizationPolicyKindAPIVersion   = OrganizationPolicyKind + "." + GroupVersion.String()
	OrganizationPolicyGroupVersionKind = GroupVersion.WithKind(OrganizationPolicyKind)
)
