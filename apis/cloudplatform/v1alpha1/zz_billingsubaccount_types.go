...
var (
	BillingSubaccountKind             = "BillingSubaccount"
	BillingSubaccountGroupKind        = schema.GroupKind{Group: Group, Kind: BillingSubaccountKind}.String()
	BillingSubaccountKindAPIVersion   = BillingSubaccountKind + "." + GroupVersion.String()
	BillingSubaccountGroupVersionKind = GroupVersion.WithKind(BillingSubaccountKind)
)
