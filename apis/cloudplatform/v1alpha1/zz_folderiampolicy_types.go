...
var (
	FolderIAMPolicyKind             = "FolderIAMPolicy"
	FolderIAMPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: FolderIAMPolicyKind}.String()
	FolderIAMPolicyKindAPIVersion   = FolderIAMPolicyKind + "." + GroupVersion.String()
	FolderIAMPolicyGroupVersionKind = GroupVersion.WithKind(FolderIAMPolicyKind)
)
