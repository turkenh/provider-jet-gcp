...
var (
	OrganizationIAMAuditConfigKind             = "OrganizationIAMAuditConfig"
	OrganizationIAMAuditConfigGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationIAMAuditConfigKind}.String()
	OrganizationIAMAuditConfigKindAPIVersion   = OrganizationIAMAuditConfigKind + "." + GroupVersion.String()
	OrganizationIAMAuditConfigGroupVersionKind = GroupVersion.WithKind(OrganizationIAMAuditConfigKind)
)
