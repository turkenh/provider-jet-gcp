...
var (
	ProjectOrganizationPolicyKind             = "ProjectOrganizationPolicy"
	ProjectOrganizationPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectOrganizationPolicyKind}.String()
	ProjectOrganizationPolicyKindAPIVersion   = ProjectOrganizationPolicyKind + "." + GroupVersion.String()
	ProjectOrganizationPolicyGroupVersionKind = GroupVersion.WithKind(ProjectOrganizationPolicyKind)
)
