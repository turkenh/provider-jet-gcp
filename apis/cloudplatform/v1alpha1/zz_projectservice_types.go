...
var (
	ProjectServiceKind             = "ProjectService"
	ProjectServiceGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectServiceKind}.String()
	ProjectServiceKindAPIVersion   = ProjectServiceKind + "." + GroupVersion.String()
	ProjectServiceGroupVersionKind = GroupVersion.WithKind(ProjectServiceKind)
)
