...
var (
	ServiceAccountIAMPolicyKind             = "ServiceAccountIAMPolicy"
	ServiceAccountIAMPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceAccountIAMPolicyKind}.String()
	ServiceAccountIAMPolicyKindAPIVersion   = ServiceAccountIAMPolicyKind + "." + GroupVersion.String()
	ServiceAccountIAMPolicyGroupVersionKind = GroupVersion.WithKind(ServiceAccountIAMPolicyKind)
)
