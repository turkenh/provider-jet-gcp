...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceAccountIAMPolicy
func (tr *ServiceAccountIAMPolicy) GetTerraformResourceIDField() string {
	return "id"
}
