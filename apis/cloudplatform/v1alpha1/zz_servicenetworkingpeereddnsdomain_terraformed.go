...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceNetworkingPeeredDNSDomain
func (tr *ServiceNetworkingPeeredDNSDomain) GetTerraformResourceIDField() string {
	return "id"
}
