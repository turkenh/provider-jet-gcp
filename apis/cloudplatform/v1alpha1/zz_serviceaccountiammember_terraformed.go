...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceAccountIAMMember
func (tr *ServiceAccountIAMMember) GetTerraformResourceIDField() string {
	return "id"
}
