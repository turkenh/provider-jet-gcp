...
var (
	OrganizationIAMPolicyKind             = "OrganizationIAMPolicy"
	OrganizationIAMPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationIAMPolicyKind}.String()
	OrganizationIAMPolicyKindAPIVersion   = OrganizationIAMPolicyKind + "." + GroupVersion.String()
	OrganizationIAMPolicyGroupVersionKind = GroupVersion.WithKind(OrganizationIAMPolicyKind)
)
