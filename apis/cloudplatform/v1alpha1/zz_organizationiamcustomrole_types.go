...
var (
	OrganizationIAMCustomRoleKind             = "OrganizationIAMCustomRole"
	OrganizationIAMCustomRoleGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationIAMCustomRoleKind}.String()
	OrganizationIAMCustomRoleKindAPIVersion   = OrganizationIAMCustomRoleKind + "." + GroupVersion.String()
	OrganizationIAMCustomRoleGroupVersionKind = GroupVersion.WithKind(OrganizationIAMCustomRoleKind)
)
