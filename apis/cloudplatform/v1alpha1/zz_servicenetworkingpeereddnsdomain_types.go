...
var (
	ServiceNetworkingPeeredDNSDomainKind             = "ServiceNetworkingPeeredDNSDomain"
	ServiceNetworkingPeeredDNSDomainGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceNetworkingPeeredDNSDomainKind}.String()
	ServiceNetworkingPeeredDNSDomainKindAPIVersion   = ServiceNetworkingPeeredDNSDomainKind + "." + GroupVersion.String()
	ServiceNetworkingPeeredDNSDomainGroupVersionKind = GroupVersion.WithKind(ServiceNetworkingPeeredDNSDomainKind)
)
