...
var (
	ServiceAccountIAMBindingKind             = "ServiceAccountIAMBinding"
	ServiceAccountIAMBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceAccountIAMBindingKind}.String()
	ServiceAccountIAMBindingKindAPIVersion   = ServiceAccountIAMBindingKind + "." + GroupVersion.String()
	ServiceAccountIAMBindingGroupVersionKind = GroupVersion.WithKind(ServiceAccountIAMBindingKind)
)
