...
var (
	OrganizationFeedKind             = "OrganizationFeed"
	OrganizationFeedGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationFeedKind}.String()
	OrganizationFeedKindAPIVersion   = OrganizationFeedKind + "." + GroupVersion.String()
	OrganizationFeedGroupVersionKind = GroupVersion.WithKind(OrganizationFeedKind)
)
