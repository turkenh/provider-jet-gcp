...
var (
	FolderFeedKind             = "FolderFeed"
	FolderFeedGroupKind        = schema.GroupKind{Group: Group, Kind: FolderFeedKind}.String()
	FolderFeedKindAPIVersion   = FolderFeedKind + "." + GroupVersion.String()
	FolderFeedGroupVersionKind = GroupVersion.WithKind(FolderFeedKind)
)
