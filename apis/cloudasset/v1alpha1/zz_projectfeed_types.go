...
var (
	ProjectFeedKind             = "ProjectFeed"
	ProjectFeedGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectFeedKind}.String()
	ProjectFeedKindAPIVersion   = ProjectFeedKind + "." + GroupVersion.String()
	ProjectFeedGroupVersionKind = GroupVersion.WithKind(ProjectFeedKind)
)
