...
var (
	ConfigPatchDeploymentKind             = "ConfigPatchDeployment"
	ConfigPatchDeploymentGroupKind        = schema.GroupKind{Group: Group, Kind: ConfigPatchDeploymentKind}.String()
	ConfigPatchDeploymentKindAPIVersion   = ConfigPatchDeploymentKind + "." + GroupVersion.String()
	ConfigPatchDeploymentGroupVersionKind = GroupVersion.WithKind(ConfigPatchDeploymentKind)
)
