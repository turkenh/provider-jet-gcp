...
var (
	ConsentStoreIamMemberKind             = "ConsentStoreIamMember"
	ConsentStoreIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ConsentStoreIamMemberKind}.String()
	ConsentStoreIamMemberKindAPIVersion   = ConsentStoreIamMemberKind + "." + GroupVersion.String()
	ConsentStoreIamMemberGroupVersionKind = GroupVersion.WithKind(ConsentStoreIamMemberKind)
)
