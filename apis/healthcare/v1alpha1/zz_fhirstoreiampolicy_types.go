...
var (
	FhirStoreIamPolicyKind             = "FhirStoreIamPolicy"
	FhirStoreIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: FhirStoreIamPolicyKind}.String()
	FhirStoreIamPolicyKindAPIVersion   = FhirStoreIamPolicyKind + "." + GroupVersion.String()
	FhirStoreIamPolicyGroupVersionKind = GroupVersion.WithKind(FhirStoreIamPolicyKind)
)
