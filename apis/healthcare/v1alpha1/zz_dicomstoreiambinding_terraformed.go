...
// GetTerraformResourceIDField returns Terraform identifier field for this DicomStoreIamBinding
func (tr *DicomStoreIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
