...
var (
	Hl7V2StoreKind             = "Hl7V2Store"
	Hl7V2StoreGroupKind        = schema.GroupKind{Group: Group, Kind: Hl7V2StoreKind}.String()
	Hl7V2StoreKindAPIVersion   = Hl7V2StoreKind + "." + GroupVersion.String()
	Hl7V2StoreGroupVersionKind = GroupVersion.WithKind(Hl7V2StoreKind)
)
