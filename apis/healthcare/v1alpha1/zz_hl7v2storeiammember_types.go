...
var (
	Hl7V2StoreIamMemberKind             = "Hl7V2StoreIamMember"
	Hl7V2StoreIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: Hl7V2StoreIamMemberKind}.String()
	Hl7V2StoreIamMemberKindAPIVersion   = Hl7V2StoreIamMemberKind + "." + GroupVersion.String()
	Hl7V2StoreIamMemberGroupVersionKind = GroupVersion.WithKind(Hl7V2StoreIamMemberKind)
)
