...
var (
	DicomStoreKind             = "DicomStore"
	DicomStoreGroupKind        = schema.GroupKind{Group: Group, Kind: DicomStoreKind}.String()
	DicomStoreKindAPIVersion   = DicomStoreKind + "." + GroupVersion.String()
	DicomStoreGroupVersionKind = GroupVersion.WithKind(DicomStoreKind)
)
