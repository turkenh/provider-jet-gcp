...
// GetTerraformResourceIDField returns Terraform identifier field for this FhirStoreIamPolicy
func (tr *FhirStoreIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
