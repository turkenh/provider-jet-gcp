...
var (
	DatasetIamMemberKind             = "DatasetIamMember"
	DatasetIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: DatasetIamMemberKind}.String()
	DatasetIamMemberKindAPIVersion   = DatasetIamMemberKind + "." + GroupVersion.String()
	DatasetIamMemberGroupVersionKind = GroupVersion.WithKind(DatasetIamMemberKind)
)
