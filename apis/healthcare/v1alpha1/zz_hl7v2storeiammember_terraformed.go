...
// GetTerraformResourceIDField returns Terraform identifier field for this Hl7V2StoreIamMember
func (tr *Hl7V2StoreIamMember) GetTerraformResourceIDField() string {
	return "id"
}
