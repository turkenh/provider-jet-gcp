...
var (
	DatasetIamBindingKind             = "DatasetIamBinding"
	DatasetIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: DatasetIamBindingKind}.String()
	DatasetIamBindingKindAPIVersion   = DatasetIamBindingKind + "." + GroupVersion.String()
	DatasetIamBindingGroupVersionKind = GroupVersion.WithKind(DatasetIamBindingKind)
)
