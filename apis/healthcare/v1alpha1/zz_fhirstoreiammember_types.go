...
var (
	FhirStoreIamMemberKind             = "FhirStoreIamMember"
	FhirStoreIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: FhirStoreIamMemberKind}.String()
	FhirStoreIamMemberKindAPIVersion   = FhirStoreIamMemberKind + "." + GroupVersion.String()
	FhirStoreIamMemberGroupVersionKind = GroupVersion.WithKind(FhirStoreIamMemberKind)
)
