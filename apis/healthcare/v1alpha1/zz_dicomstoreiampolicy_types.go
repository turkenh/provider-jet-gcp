...
var (
	DicomStoreIamPolicyKind             = "DicomStoreIamPolicy"
	DicomStoreIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: DicomStoreIamPolicyKind}.String()
	DicomStoreIamPolicyKindAPIVersion   = DicomStoreIamPolicyKind + "." + GroupVersion.String()
	DicomStoreIamPolicyGroupVersionKind = GroupVersion.WithKind(DicomStoreIamPolicyKind)
)
