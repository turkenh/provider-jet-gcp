...
var (
	DatasetIamPolicyKind             = "DatasetIamPolicy"
	DatasetIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: DatasetIamPolicyKind}.String()
	DatasetIamPolicyKindAPIVersion   = DatasetIamPolicyKind + "." + GroupVersion.String()
	DatasetIamPolicyGroupVersionKind = GroupVersion.WithKind(DatasetIamPolicyKind)
)
