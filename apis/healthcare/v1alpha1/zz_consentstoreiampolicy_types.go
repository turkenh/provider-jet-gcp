...
var (
	ConsentStoreIamPolicyKind             = "ConsentStoreIamPolicy"
	ConsentStoreIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ConsentStoreIamPolicyKind}.String()
	ConsentStoreIamPolicyKindAPIVersion   = ConsentStoreIamPolicyKind + "." + GroupVersion.String()
	ConsentStoreIamPolicyGroupVersionKind = GroupVersion.WithKind(ConsentStoreIamPolicyKind)
)
