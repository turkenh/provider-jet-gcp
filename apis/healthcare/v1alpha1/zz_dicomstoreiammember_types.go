...
var (
	DicomStoreIamMemberKind             = "DicomStoreIamMember"
	DicomStoreIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: DicomStoreIamMemberKind}.String()
	DicomStoreIamMemberKindAPIVersion   = DicomStoreIamMemberKind + "." + GroupVersion.String()
	DicomStoreIamMemberGroupVersionKind = GroupVersion.WithKind(DicomStoreIamMemberKind)
)
