...
// GetTerraformResourceIDField returns Terraform identifier field for this FhirStoreIamMember
func (tr *FhirStoreIamMember) GetTerraformResourceIDField() string {
	return "id"
}
