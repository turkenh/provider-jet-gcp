...
var (
	FhirStoreIamBindingKind             = "FhirStoreIamBinding"
	FhirStoreIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: FhirStoreIamBindingKind}.String()
	FhirStoreIamBindingKindAPIVersion   = FhirStoreIamBindingKind + "." + GroupVersion.String()
	FhirStoreIamBindingGroupVersionKind = GroupVersion.WithKind(FhirStoreIamBindingKind)
)
