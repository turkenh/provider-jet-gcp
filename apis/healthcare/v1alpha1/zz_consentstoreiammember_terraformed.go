...
// GetTerraformResourceIDField returns Terraform identifier field for this ConsentStoreIamMember
func (tr *ConsentStoreIamMember) GetTerraformResourceIDField() string {
	return "id"
}
