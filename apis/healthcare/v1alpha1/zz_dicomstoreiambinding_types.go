...
var (
	DicomStoreIamBindingKind             = "DicomStoreIamBinding"
	DicomStoreIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: DicomStoreIamBindingKind}.String()
	DicomStoreIamBindingKindAPIVersion   = DicomStoreIamBindingKind + "." + GroupVersion.String()
	DicomStoreIamBindingGroupVersionKind = GroupVersion.WithKind(DicomStoreIamBindingKind)
)
