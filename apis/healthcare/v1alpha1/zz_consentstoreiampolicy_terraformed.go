...
// GetTerraformResourceIDField returns Terraform identifier field for this ConsentStoreIamPolicy
func (tr *ConsentStoreIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
