...
// GetTerraformResourceIDField returns Terraform identifier field for this DicomStoreIamMember
func (tr *DicomStoreIamMember) GetTerraformResourceIDField() string {
	return "id"
}
