...
var (
	ConsentStoreKind             = "ConsentStore"
	ConsentStoreGroupKind        = schema.GroupKind{Group: Group, Kind: ConsentStoreKind}.String()
	ConsentStoreKindAPIVersion   = ConsentStoreKind + "." + GroupVersion.String()
	ConsentStoreGroupVersionKind = GroupVersion.WithKind(ConsentStoreKind)
)
