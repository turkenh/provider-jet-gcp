...
// GetTerraformResourceIDField returns Terraform identifier field for this Hl7V2StoreIamBinding
func (tr *Hl7V2StoreIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
