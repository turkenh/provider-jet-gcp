...
// GetTerraformResourceIDField returns Terraform identifier field for this Hl7V2StoreIamPolicy
func (tr *Hl7V2StoreIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
