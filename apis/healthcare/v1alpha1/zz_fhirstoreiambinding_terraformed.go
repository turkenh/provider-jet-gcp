...
// GetTerraformResourceIDField returns Terraform identifier field for this FhirStoreIamBinding
func (tr *FhirStoreIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
