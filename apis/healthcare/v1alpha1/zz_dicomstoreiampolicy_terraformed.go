...
// GetTerraformResourceIDField returns Terraform identifier field for this DicomStoreIamPolicy
func (tr *DicomStoreIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
