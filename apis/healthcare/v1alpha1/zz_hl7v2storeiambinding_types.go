...
var (
	Hl7V2StoreIamBindingKind             = "Hl7V2StoreIamBinding"
	Hl7V2StoreIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: Hl7V2StoreIamBindingKind}.String()
	Hl7V2StoreIamBindingKindAPIVersion   = Hl7V2StoreIamBindingKind + "." + GroupVersion.String()
	Hl7V2StoreIamBindingGroupVersionKind = GroupVersion.WithKind(Hl7V2StoreIamBindingKind)
)
