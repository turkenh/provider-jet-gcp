...
var (
	ConsentStoreIamBindingKind             = "ConsentStoreIamBinding"
	ConsentStoreIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ConsentStoreIamBindingKind}.String()
	ConsentStoreIamBindingKindAPIVersion   = ConsentStoreIamBindingKind + "." + GroupVersion.String()
	ConsentStoreIamBindingGroupVersionKind = GroupVersion.WithKind(ConsentStoreIamBindingKind)
)
