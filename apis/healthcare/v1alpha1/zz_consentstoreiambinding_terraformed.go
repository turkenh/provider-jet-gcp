...
// GetTerraformResourceIDField returns Terraform identifier field for this ConsentStoreIamBinding
func (tr *ConsentStoreIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
