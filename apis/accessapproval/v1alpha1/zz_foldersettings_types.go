...
var (
	FolderSettingsKind             = "FolderSettings"
	FolderSettingsGroupKind        = schema.GroupKind{Group: Group, Kind: FolderSettingsKind}.String()
	FolderSettingsKindAPIVersion   = FolderSettingsKind + "." + GroupVersion.String()
	FolderSettingsGroupVersionKind = GroupVersion.WithKind(FolderSettingsKind)
)
