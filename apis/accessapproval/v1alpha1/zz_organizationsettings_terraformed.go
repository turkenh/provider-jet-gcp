...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationSettings
func (tr *OrganizationSettings) GetTerraformResourceIDField() string {
	return "id"
}
