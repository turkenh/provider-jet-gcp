...
var (
	ProjectSettingsKind             = "ProjectSettings"
	ProjectSettingsGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectSettingsKind}.String()
	ProjectSettingsKindAPIVersion   = ProjectSettingsKind + "." + GroupVersion.String()
	ProjectSettingsGroupVersionKind = GroupVersion.WithKind(ProjectSettingsKind)
)
