...
var (
	...
	OrganizationSettingsGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationSettingsKind}.String()
	OrganizationSettingsKindAPIVersion   = OrganizationSettingsKind + "." + GroupVersion.String()
	OrganizationSettingsGroupVersionKind = GroupVersion.WithKind(OrganizationSettingsKind)
)
