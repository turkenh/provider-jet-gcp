...
var (
	SecretIamPolicyKind             = "SecretIamPolicy"
	SecretIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SecretIamPolicyKind}.String()
	SecretIamPolicyKindAPIVersion   = SecretIamPolicyKind + "." + GroupVersion.String()
	SecretIamPolicyGroupVersionKind = GroupVersion.WithKind(SecretIamPolicyKind)
)
