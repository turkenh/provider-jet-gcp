...
var (
	SecretIamMemberKind             = "SecretIamMember"
	SecretIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: SecretIamMemberKind}.String()
	SecretIamMemberKindAPIVersion   = SecretIamMemberKind + "." + GroupVersion.String()
	SecretIamMemberGroupVersionKind = GroupVersion.WithKind(SecretIamMemberKind)
)
