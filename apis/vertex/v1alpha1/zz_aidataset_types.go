...
var (
	AiDatasetKind             = "AiDataset"
	AiDatasetGroupKind        = schema.GroupKind{Group: Group, Kind: AiDatasetKind}.String()
	AiDatasetKindAPIVersion   = AiDatasetKind + "." + GroupVersion.String()
	AiDatasetGroupVersionKind = GroupVersion.WithKind(AiDatasetKind)
)
