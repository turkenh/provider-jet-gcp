...
var (
	TenantOauthIdpConfigKind             = "TenantOauthIdpConfig"
	TenantOauthIdpConfigGroupKind        = schema.GroupKind{Group: Group, Kind: TenantOauthIdpConfigKind}.String()
	TenantOauthIdpConfigKindAPIVersion   = TenantOauthIdpConfigKind + "." + GroupVersion.String()
	TenantOauthIdpConfigGroupVersionKind = GroupVersion.WithKind(TenantOauthIdpConfigKind)
)
