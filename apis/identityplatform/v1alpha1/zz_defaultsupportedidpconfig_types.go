...
var (
	DefaultSupportedIdpConfigKind             = "DefaultSupportedIdpConfig"
	DefaultSupportedIdpConfigGroupKind        = schema.GroupKind{Group: Group, Kind: DefaultSupportedIdpConfigKind}.String()
	DefaultSupportedIdpConfigKindAPIVersion   = DefaultSupportedIdpConfigKind + "." + GroupVersion.String()
	DefaultSupportedIdpConfigGroupVersionKind = GroupVersion.WithKind(DefaultSupportedIdpConfigKind)
)
