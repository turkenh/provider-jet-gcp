...
// GetTerraformResourceIDField returns Terraform identifier field for this TenantOauthIdpConfig
func (tr *TenantOauthIdpConfig) GetTerraformResourceIDField() string {
	return "id"
}
