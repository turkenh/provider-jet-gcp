...
var (
	TenantDefaultSupportedIdpConfigKind             = "TenantDefaultSupportedIdpConfig"
	TenantDefaultSupportedIdpConfigGroupKind        = schema.GroupKind{Group: Group, Kind: TenantDefaultSupportedIdpConfigKind}.String()
	TenantDefaultSupportedIdpConfigKindAPIVersion   = TenantDefaultSupportedIdpConfigKind + "." + GroupVersion.String()
	TenantDefaultSupportedIdpConfigGroupVersionKind = GroupVersion.WithKind(TenantDefaultSupportedIdpConfigKind)
)
