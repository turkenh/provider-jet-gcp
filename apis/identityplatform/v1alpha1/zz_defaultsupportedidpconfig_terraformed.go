...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultSupportedIdpConfig
func (tr *DefaultSupportedIdpConfig) GetTerraformResourceIDField() string {
	return "id"
}
