...
var (
	OauthIdpConfigKind             = "OauthIdpConfig"
	OauthIdpConfigGroupKind        = schema.GroupKind{Group: Group, Kind: OauthIdpConfigKind}.String()
	OauthIdpConfigKindAPIVersion   = OauthIdpConfigKind + "." + GroupVersion.String()
	OauthIdpConfigGroupVersionKind = GroupVersion.WithKind(OauthIdpConfigKind)
)
