...
// GetTerraformResourceIDField returns Terraform identifier field for this TenantInboundSamlConfig
func (tr *TenantInboundSamlConfig) GetTerraformResourceIDField() string {
	return "id"
}
