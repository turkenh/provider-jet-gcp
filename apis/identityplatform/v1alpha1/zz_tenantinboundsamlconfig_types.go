...
var (
	TenantInboundSamlConfigKind             = "TenantInboundSamlConfig"
	TenantInboundSamlConfigGroupKind        = schema.GroupKind{Group: Group, Kind: TenantInboundSamlConfigKind}.String()
	TenantInboundSamlConfigKindAPIVersion   = TenantInboundSamlConfigKind + "." + GroupVersion.String()
	TenantInboundSamlConfigGroupVersionKind = GroupVersion.WithKind(TenantInboundSamlConfigKind)
)
