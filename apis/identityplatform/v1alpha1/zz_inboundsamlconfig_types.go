...
var (
	InboundSamlConfigKind             = "InboundSamlConfig"
	InboundSamlConfigGroupKind        = schema.GroupKind{Group: Group, Kind: InboundSamlConfigKind}.String()
	InboundSamlConfigKindAPIVersion   = InboundSamlConfigKind + "." + GroupVersion.String()
	InboundSamlConfigGroupVersionKind = GroupVersion.WithKind(InboundSamlConfigKind)
)
