...
// GetTerraformResourceIDField returns Terraform identifier field for this TenantDefaultSupportedIdpConfig
func (tr *TenantDefaultSupportedIdpConfig) GetTerraformResourceIDField() string {
	return "id"
}
