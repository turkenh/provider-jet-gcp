...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceSplitTraffic
func (tr *ServiceSplitTraffic) GetTerraformResourceIDField() string {
	return "id"
}
