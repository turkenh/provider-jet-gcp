...
var (
	StandardAppVersionKind             = "StandardAppVersion"
	StandardAppVersionGroupKind        = schema.GroupKind{Group: Group, Kind: StandardAppVersionKind}.String()
	StandardAppVersionKindAPIVersion   = StandardAppVersionKind + "." + GroupVersion.String()
	StandardAppVersionGroupVersionKind = GroupVersion.WithKind(StandardAppVersionKind)
)
