...
// GetTerraformResourceIDField returns Terraform identifier field for this StandardAppVersion
func (tr *StandardAppVersion) GetTerraformResourceIDField() string {
	return "id"
}
