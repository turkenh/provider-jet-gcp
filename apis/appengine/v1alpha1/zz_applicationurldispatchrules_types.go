...
var (
	ApplicationUrlDispatchRulesKind             = "ApplicationUrlDispatchRules"
	ApplicationUrlDispatchRulesGroupKind        = schema.GroupKind{Group: Group, Kind: ApplicationUrlDispatchRulesKind}.String()
	ApplicationUrlDispatchRulesKindAPIVersion   = ApplicationUrlDispatchRulesKind + "." + GroupVersion.String()
	ApplicationUrlDispatchRulesGroupVersionKind = GroupVersion.WithKind(ApplicationUrlDispatchRulesKind)
)
