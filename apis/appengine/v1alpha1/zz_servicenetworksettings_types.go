...
var (
	ServiceNetworkSettingsKind             = "ServiceNetworkSettings"
	ServiceNetworkSettingsGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceNetworkSettingsKind}.String()
	ServiceNetworkSettingsKindAPIVersion   = ServiceNetworkSettingsKind + "." + GroupVersion.String()
	ServiceNetworkSettingsGroupVersionKind = GroupVersion.WithKind(ServiceNetworkSettingsKind)
)
