...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceNetworkSettings
func (tr *ServiceNetworkSettings) GetTerraformResourceIDField() string {
	return "id"
}
