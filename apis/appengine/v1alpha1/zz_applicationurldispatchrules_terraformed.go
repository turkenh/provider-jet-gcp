...
// GetTerraformResourceIDField returns Terraform identifier field for this ApplicationUrlDispatchRules
func (tr *ApplicationUrlDispatchRules) GetTerraformResourceIDField() string {
	return "id"
}
