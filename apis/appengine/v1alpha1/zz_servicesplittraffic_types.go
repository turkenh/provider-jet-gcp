...
var (
	ServiceSplitTrafficKind             = "ServiceSplitTraffic"
	ServiceSplitTrafficGroupKind        = schema.GroupKind{Group: Group, Kind: ServiceSplitTrafficKind}.String()
	ServiceSplitTrafficKindAPIVersion   = ServiceSplitTrafficKind + "." + GroupVersion.String()
	ServiceSplitTrafficGroupVersionKind = GroupVersion.WithKind(ServiceSplitTrafficKind)
)
