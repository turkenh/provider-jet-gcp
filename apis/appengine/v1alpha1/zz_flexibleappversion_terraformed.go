...
// GetTerraformResourceIDField returns Terraform identifier field for this FlexibleAppVersion
func (tr *FlexibleAppVersion) GetTerraformResourceIDField() string {
	return "id"
}
