...
var (
	FlexibleAppVersionKind             = "FlexibleAppVersion"
	FlexibleAppVersionGroupKind        = schema.GroupKind{Group: Group, Kind: FlexibleAppVersionKind}.String()
	FlexibleAppVersionKindAPIVersion   = FlexibleAppVersionKind + "." + GroupVersion.String()
	FlexibleAppVersionGroupVersionKind = GroupVersion.WithKind(FlexibleAppVersionKind)
)
