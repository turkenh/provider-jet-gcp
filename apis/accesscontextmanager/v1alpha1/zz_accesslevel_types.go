...
var (
	...
	AccessLevelGroupKind        = schema.GroupKind{Group: Group, Kind: AccessLevelKind}.String()
	AccessLevelKindAPIVersion   = AccessLevelKind + "." + GroupVersion.String()
	AccessLevelGroupVersionKind = GroupVersion.WithKind(AccessLevelKind)
)
