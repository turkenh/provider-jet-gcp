...
// GetTerraformResourceIDField returns Terraform identifier field for this ServicePerimeterResource
func (tr *ServicePerimeterResource) GetTerraformResourceIDField() string {
	return "id"
}
