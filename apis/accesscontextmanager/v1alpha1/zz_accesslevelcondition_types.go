...
var (
	AccessLevelConditionKind             = "AccessLevelCondition"
	AccessLevelConditionGroupKind        = schema.GroupKind{Group: Group, Kind: AccessLevelConditionKind}.String()
	AccessLevelConditionKindAPIVersion   = AccessLevelConditionKind + "." + GroupVersion.String()
	AccessLevelConditionGroupVersionKind = GroupVersion.WithKind(AccessLevelConditionKind)
)
