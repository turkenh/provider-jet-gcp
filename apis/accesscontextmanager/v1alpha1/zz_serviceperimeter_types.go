...
var (
	ServicePerimeterKind             = "ServicePerimeter"
	ServicePerimeterGroupKind        = schema.GroupKind{Group: Group, Kind: ServicePerimeterKind}.String()
	ServicePerimeterKindAPIVersion   = ServicePerimeterKind + "." + GroupVersion.String()
	ServicePerimeterGroupVersionKind = GroupVersion.WithKind(ServicePerimeterKind)
)
