...
var (
	ServicePerimeterResourceKind             = "ServicePerimeterResource"
	ServicePerimeterResourceGroupKind        = schema.GroupKind{Group: Group, Kind: ServicePerimeterResourceKind}.String()
	ServicePerimeterResourceKindAPIVersion   = ServicePerimeterResourceKind + "." + GroupVersion.String()
	ServicePerimeterResourceGroupVersionKind = GroupVersion.WithKind(ServicePerimeterResourceKind)
)
