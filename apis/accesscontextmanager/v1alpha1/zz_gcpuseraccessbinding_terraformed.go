...
// GetTerraformResourceIDField returns Terraform identifier field for this GcpUserAccessBinding
func (tr *GcpUserAccessBinding) GetTerraformResourceIDField() string {
	return "id"
}
