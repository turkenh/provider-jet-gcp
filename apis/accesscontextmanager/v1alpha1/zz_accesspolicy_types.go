...
var (
	...
	AccessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AccessPolicyKind}.String()
	AccessPolicyKindAPIVersion   = AccessPolicyKind + "." + GroupVersion.String()
	AccessPolicyGroupVersionKind = GroupVersion.WithKind(AccessPolicyKind)
)
