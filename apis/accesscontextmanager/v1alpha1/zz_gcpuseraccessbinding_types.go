...
var (
	GcpUserAccessBindingKind             = "GcpUserAccessBinding"
	GcpUserAccessBindingGroupKind        = schema.GroupKind{Group: Group, Kind: GcpUserAccessBindingKind}.String()
	GcpUserAccessBindingKindAPIVersion   = GcpUserAccessBindingKind + "." + GroupVersion.String()
	GcpUserAccessBindingGroupVersionKind = GroupVersion.WithKind(GcpUserAccessBindingKind)
)
