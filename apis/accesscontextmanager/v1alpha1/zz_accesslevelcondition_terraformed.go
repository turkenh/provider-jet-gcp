...
// GetTerraformResourceIDField returns Terraform identifier field for this AccessLevelCondition
func (tr *AccessLevelCondition) GetTerraformResourceIDField() string {
	return "id"
}
