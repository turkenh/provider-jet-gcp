...
var (
	GameServerClusterKind             = "GameServerCluster"
	GameServerClusterGroupKind        = schema.GroupKind{Group: Group, Kind: GameServerClusterKind}.String()
	GameServerClusterKindAPIVersion   = GameServerClusterKind + "." + GroupVersion.String()
	GameServerClusterGroupVersionKind = GroupVersion.WithKind(GameServerClusterKind)
)
