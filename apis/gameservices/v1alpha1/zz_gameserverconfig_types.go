...
var (
	GameServerConfigKind             = "GameServerConfig"
	GameServerConfigGroupKind        = schema.GroupKind{Group: Group, Kind: GameServerConfigKind}.String()
	GameServerConfigKindAPIVersion   = GameServerConfigKind + "." + GroupVersion.String()
	GameServerConfigGroupVersionKind = GroupVersion.WithKind(GameServerConfigKind)
)
