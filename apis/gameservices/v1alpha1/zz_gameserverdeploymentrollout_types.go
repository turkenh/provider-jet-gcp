...
var (
	GameServerDeploymentRolloutKind             = "GameServerDeploymentRollout"
	GameServerDeploymentRolloutGroupKind        = schema.GroupKind{Group: Group, Kind: GameServerDeploymentRolloutKind}.String()
	GameServerDeploymentRolloutKindAPIVersion   = GameServerDeploymentRolloutKind + "." + GroupVersion.String()
	GameServerDeploymentRolloutGroupVersionKind = GroupVersion.WithKind(GameServerDeploymentRolloutKind)
)
