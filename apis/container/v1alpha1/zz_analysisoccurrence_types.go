...
var (
	AnalysisOccurrenceKind             = "AnalysisOccurrence"
	AnalysisOccurrenceGroupKind        = schema.GroupKind{Group: Group, Kind: AnalysisOccurrenceKind}.String()
	AnalysisOccurrenceKindAPIVersion   = AnalysisOccurrenceKind + "." + GroupVersion.String()
	AnalysisOccurrenceGroupVersionKind = GroupVersion.WithKind(AnalysisOccurrenceKind)
)
