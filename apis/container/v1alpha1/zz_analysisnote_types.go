...
var (
	AnalysisNoteKind             = "AnalysisNote"
	AnalysisNoteGroupKind        = schema.GroupKind{Group: Group, Kind: AnalysisNoteKind}.String()
	AnalysisNoteKindAPIVersion   = AnalysisNoteKind + "." + GroupVersion.String()
	AnalysisNoteGroupVersionKind = GroupVersion.WithKind(AnalysisNoteKind)
)
