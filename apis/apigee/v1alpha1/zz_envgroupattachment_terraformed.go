...
// GetTerraformResourceIDField returns Terraform identifier field for this EnvgroupAttachment
func (tr *EnvgroupAttachment) GetTerraformResourceIDField() string {
	return "id"
}
