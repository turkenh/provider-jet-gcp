...
var (
	EnvgroupKind             = "Envgroup"
	EnvgroupGroupKind        = schema.GroupKind{Group: Group, Kind: EnvgroupKind}.String()
	EnvgroupKindAPIVersion   = EnvgroupKind + "." + GroupVersion.String()
	EnvgroupGroupVersionKind = GroupVersion.WithKind(EnvgroupKind)
)
