...
// GetTerraformResourceIDField returns Terraform identifier field for this InstanceAttachment
func (tr *InstanceAttachment) GetTerraformResourceIDField() string {
	return "id"
}
