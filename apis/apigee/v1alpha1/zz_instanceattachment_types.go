...
var (
	InstanceAttachmentKind             = "InstanceAttachment"
	InstanceAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceAttachmentKind}.String()
	InstanceAttachmentKindAPIVersion   = InstanceAttachmentKind + "." + GroupVersion.String()
	InstanceAttachmentGroupVersionKind = GroupVersion.WithKind(InstanceAttachmentKind)
)
