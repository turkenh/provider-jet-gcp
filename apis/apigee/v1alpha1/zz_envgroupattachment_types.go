...
var (
	EnvgroupAttachmentKind             = "EnvgroupAttachment"
	EnvgroupAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: EnvgroupAttachmentKind}.String()
	EnvgroupAttachmentKindAPIVersion   = EnvgroupAttachmentKind + "." + GroupVersion.String()
	EnvgroupAttachmentGroupVersionKind = GroupVersion.WithKind(EnvgroupAttachmentKind)
)
