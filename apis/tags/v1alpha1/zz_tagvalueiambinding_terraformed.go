...
// GetTerraformResourceIDField returns Terraform identifier field for this TagValueIamBinding
func (tr *TagValueIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
