...
var (
	TagKeyKind             = "TagKey"
	TagKeyGroupKind        = schema.GroupKind{Group: Group, Kind: TagKeyKind}.String()
	TagKeyKindAPIVersion   = TagKeyKind + "." + GroupVersion.String()
	TagKeyGroupVersionKind = GroupVersion.WithKind(TagKeyKind)
)
