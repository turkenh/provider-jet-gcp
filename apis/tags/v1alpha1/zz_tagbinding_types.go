...
var (
	TagBindingKind             = "TagBinding"
	TagBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TagBindingKind}.String()
	TagBindingKindAPIVersion   = TagBindingKind + "." + GroupVersion.String()
	TagBindingGroupVersionKind = GroupVersion.WithKind(TagBindingKind)
)
