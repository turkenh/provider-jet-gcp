...
var (
	TagKeyIamBindingKind             = "TagKeyIamBinding"
	TagKeyIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TagKeyIamBindingKind}.String()
	TagKeyIamBindingKindAPIVersion   = TagKeyIamBindingKind + "." + GroupVersion.String()
	TagKeyIamBindingGroupVersionKind = GroupVersion.WithKind(TagKeyIamBindingKind)
)
