...
var (
	TagValueKind             = "TagValue"
	TagValueGroupKind        = schema.GroupKind{Group: Group, Kind: TagValueKind}.String()
	TagValueKindAPIVersion   = TagValueKind + "." + GroupVersion.String()
	TagValueGroupVersionKind = GroupVersion.WithKind(TagValueKind)
)
