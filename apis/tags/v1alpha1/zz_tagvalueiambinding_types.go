...
var (
	TagValueIamBindingKind             = "TagValueIamBinding"
	TagValueIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TagValueIamBindingKind}.String()
	TagValueIamBindingKindAPIVersion   = TagValueIamBindingKind + "." + GroupVersion.String()
	TagValueIamBindingGroupVersionKind = GroupVersion.WithKind(TagValueIamBindingKind)
)
