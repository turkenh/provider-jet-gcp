...
var (
	TagKeyIamMemberKind             = "TagKeyIamMember"
	TagKeyIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TagKeyIamMemberKind}.String()
	TagKeyIamMemberKindAPIVersion   = TagKeyIamMemberKind + "." + GroupVersion.String()
	TagKeyIamMemberGroupVersionKind = GroupVersion.WithKind(TagKeyIamMemberKind)
)
