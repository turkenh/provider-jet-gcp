...
var (
	TagKeyIamPolicyKind             = "TagKeyIamPolicy"
	TagKeyIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TagKeyIamPolicyKind}.String()
	TagKeyIamPolicyKindAPIVersion   = TagKeyIamPolicyKind + "." + GroupVersion.String()
	TagKeyIamPolicyGroupVersionKind = GroupVersion.WithKind(TagKeyIamPolicyKind)
)
