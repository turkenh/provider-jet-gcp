...
var (
	TagValueIamMemberKind             = "TagValueIamMember"
	TagValueIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TagValueIamMemberKind}.String()
	TagValueIamMemberKindAPIVersion   = TagValueIamMemberKind + "." + GroupVersion.String()
	TagValueIamMemberGroupVersionKind = GroupVersion.WithKind(TagValueIamMemberKind)
)
