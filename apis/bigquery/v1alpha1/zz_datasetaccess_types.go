...
var (
	DatasetAccessKind             = "DatasetAccess"
	DatasetAccessGroupKind        = schema.GroupKind{Group: Group, Kind: DatasetAccessKind}.String()
	DatasetAccessKindAPIVersion   = DatasetAccessKind + "." + GroupVersion.String()
	DatasetAccessGroupVersionKind = GroupVersion.WithKind(DatasetAccessKind)
)
