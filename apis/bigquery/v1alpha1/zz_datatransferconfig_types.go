...
var (
	DataTransferConfigKind             = "DataTransferConfig"
	DataTransferConfigGroupKind        = schema.GroupKind{Group: Group, Kind: DataTransferConfigKind}.String()
	DataTransferConfigKindAPIVersion   = DataTransferConfigKind + "." + GroupVersion.String()
	DataTransferConfigGroupVersionKind = GroupVersion.WithKind(DataTransferConfigKind)
)
