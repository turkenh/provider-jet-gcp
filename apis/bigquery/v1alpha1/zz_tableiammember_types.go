...
var (
	TableIamMemberKind             = "TableIamMember"
	TableIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TableIamMemberKind}.String()
	TableIamMemberKindAPIVersion   = TableIamMemberKind + "." + GroupVersion.String()
	TableIamMemberGroupVersionKind = GroupVersion.WithKind(TableIamMemberKind)
)
