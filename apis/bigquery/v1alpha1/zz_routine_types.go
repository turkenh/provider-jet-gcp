...
var (
	RoutineKind             = "Routine"
	RoutineGroupKind        = schema.GroupKind{Group: Group, Kind: RoutineKind}.String()
	RoutineKindAPIVersion   = RoutineKind + "." + GroupVersion.String()
	RoutineGroupVersionKind = GroupVersion.WithKind(RoutineKind)
)
