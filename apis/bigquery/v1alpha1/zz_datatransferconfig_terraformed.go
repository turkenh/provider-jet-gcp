...
// GetTerraformResourceIDField returns Terraform identifier field for this DataTransferConfig
func (tr *DataTransferConfig) GetTerraformResourceIDField() string {
	return "id"
}
