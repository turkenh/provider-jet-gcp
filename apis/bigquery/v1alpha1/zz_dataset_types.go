...
var (
	DatasetKind             = "Dataset"
	DatasetGroupKind        = schema.GroupKind{Group: Group, Kind: DatasetKind}.String()
	DatasetKindAPIVersion   = DatasetKind + "." + GroupVersion.String()
	DatasetGroupVersionKind = GroupVersion.WithKind(DatasetKind)
)
