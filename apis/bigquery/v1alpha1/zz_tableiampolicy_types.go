...
var (
	TableIamPolicyKind             = "TableIamPolicy"
	TableIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TableIamPolicyKind}.String()
	TableIamPolicyKindAPIVersion   = TableIamPolicyKind + "." + GroupVersion.String()
	TableIamPolicyGroupVersionKind = GroupVersion.WithKind(TableIamPolicyKind)
)
