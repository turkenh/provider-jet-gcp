...
var (
	ConnectivityTestKind             = "ConnectivityTest"
	ConnectivityTestGroupKind        = schema.GroupKind{Group: Group, Kind: ConnectivityTestKind}.String()
	ConnectivityTestKindAPIVersion   = ConnectivityTestKind + "." + GroupVersion.String()
	ConnectivityTestGroupVersionKind = GroupVersion.WithKind(ConnectivityTestKind)
)
