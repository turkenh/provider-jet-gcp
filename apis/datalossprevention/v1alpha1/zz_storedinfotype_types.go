...
var (
	StoredInfoTypeKind             = "StoredInfoType"
	StoredInfoTypeGroupKind        = schema.GroupKind{Group: Group, Kind: StoredInfoTypeKind}.String()
	StoredInfoTypeKindAPIVersion   = StoredInfoTypeKind + "." + GroupVersion.String()
	StoredInfoTypeGroupVersionKind = GroupVersion.WithKind(StoredInfoTypeKind)
)
