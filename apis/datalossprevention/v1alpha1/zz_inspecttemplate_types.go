...
var (
	InspectTemplateKind             = "InspectTemplate"
	InspectTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: InspectTemplateKind}.String()
	InspectTemplateKindAPIVersion   = InspectTemplateKind + "." + GroupVersion.String()
	InspectTemplateGroupVersionKind = GroupVersion.WithKind(InspectTemplateKind)
)
