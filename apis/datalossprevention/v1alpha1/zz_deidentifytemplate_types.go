...
var (
	DeidentifyTemplateKind             = "DeidentifyTemplate"
	DeidentifyTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: DeidentifyTemplateKind}.String()
	DeidentifyTemplateKindAPIVersion   = DeidentifyTemplateKind + "." + GroupVersion.String()
	DeidentifyTemplateGroupVersionKind = GroupVersion.WithKind(DeidentifyTemplateKind)
)
