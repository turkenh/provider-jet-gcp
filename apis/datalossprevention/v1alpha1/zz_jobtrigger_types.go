...
var (
	JobTriggerKind             = "JobTrigger"
	JobTriggerGroupKind        = schema.GroupKind{Group: Group, Kind: JobTriggerKind}.String()
	JobTriggerKindAPIVersion   = JobTriggerKind + "." + GroupVersion.String()
	JobTriggerGroupVersionKind = GroupVersion.WithKind(JobTriggerKind)
)
