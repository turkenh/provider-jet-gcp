...
// GetTerraformResourceIDField returns Terraform identifier field for this DeidentifyTemplate
func (tr *DeidentifyTemplate) GetTerraformResourceIDField() string {
	return "id"
}
