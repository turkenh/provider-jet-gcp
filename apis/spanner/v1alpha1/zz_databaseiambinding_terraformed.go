...
// GetTerraformResourceIDField returns Terraform identifier field for this DatabaseIamBinding
func (tr *DatabaseIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
