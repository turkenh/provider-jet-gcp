...
var (
	DatabaseIamPolicyKind             = "DatabaseIamPolicy"
	DatabaseIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: DatabaseIamPolicyKind}.String()
	DatabaseIamPolicyKindAPIVersion   = DatabaseIamPolicyKind + "." + GroupVersion.String()
	DatabaseIamPolicyGroupVersionKind = GroupVersion.WithKind(DatabaseIamPolicyKind)
)
