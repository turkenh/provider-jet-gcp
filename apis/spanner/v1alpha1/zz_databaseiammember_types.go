...
var (
	DatabaseIamMemberKind             = "DatabaseIamMember"
	DatabaseIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: DatabaseIamMemberKind}.String()
	DatabaseIamMemberKindAPIVersion   = DatabaseIamMemberKind + "." + GroupVersion.String()
	DatabaseIamMemberGroupVersionKind = GroupVersion.WithKind(DatabaseIamMemberKind)
)
