...
var (
	DatabaseIamBindingKind             = "DatabaseIamBinding"
	DatabaseIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: DatabaseIamBindingKind}.String()
	DatabaseIamBindingKindAPIVersion   = DatabaseIamBindingKind + "." + GroupVersion.String()
	DatabaseIamBindingGroupVersionKind = GroupVersion.WithKind(DatabaseIamBindingKind)
)
