...
var (
	EdgeCacheKeysetKind             = "EdgeCacheKeyset"
	EdgeCacheKeysetGroupKind        = schema.GroupKind{Group: Group, Kind: EdgeCacheKeysetKind}.String()
	EdgeCacheKeysetKindAPIVersion   = EdgeCacheKeysetKind + "." + GroupVersion.String()
	EdgeCacheKeysetGroupVersionKind = GroupVersion.WithKind(EdgeCacheKeysetKind)
)
