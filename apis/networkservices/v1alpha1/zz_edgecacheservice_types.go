...
var (
	EdgeCacheServiceKind             = "EdgeCacheService"
	EdgeCacheServiceGroupKind        = schema.GroupKind{Group: Group, Kind: EdgeCacheServiceKind}.String()
	EdgeCacheServiceKindAPIVersion   = EdgeCacheServiceKind + "." + GroupVersion.String()
	EdgeCacheServiceGroupVersionKind = GroupVersion.WithKind(EdgeCacheServiceKind)
)
