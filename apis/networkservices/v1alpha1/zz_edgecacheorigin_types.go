...
var (
	EdgeCacheOriginKind             = "EdgeCacheOrigin"
	EdgeCacheOriginGroupKind        = schema.GroupKind{Group: Group, Kind: EdgeCacheOriginKind}.String()
	EdgeCacheOriginKindAPIVersion   = EdgeCacheOriginKind + "." + GroupVersion.String()
	EdgeCacheOriginGroupVersionKind = GroupVersion.WithKind(EdgeCacheOriginKind)
)
