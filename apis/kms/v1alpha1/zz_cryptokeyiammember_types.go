...
var (
	CryptoKeyIamMemberKind             = "CryptoKeyIamMember"
	CryptoKeyIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: CryptoKeyIamMemberKind}.String()
	CryptoKeyIamMemberKindAPIVersion   = CryptoKeyIamMemberKind + "." + GroupVersion.String()
	CryptoKeyIamMemberGroupVersionKind = GroupVersion.WithKind(CryptoKeyIamMemberKind)
)
