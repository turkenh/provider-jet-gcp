...
var (
	KeyRingImportJobKind             = "KeyRingImportJob"
	KeyRingImportJobGroupKind        = schema.GroupKind{Group: Group, Kind: KeyRingImportJobKind}.String()
	KeyRingImportJobKindAPIVersion   = KeyRingImportJobKind + "." + GroupVersion.String()
	KeyRingImportJobGroupVersionKind = GroupVersion.WithKind(KeyRingImportJobKind)
)
