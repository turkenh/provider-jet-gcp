...
var (
	KeyRingIamMemberKind             = "KeyRingIamMember"
	KeyRingIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: KeyRingIamMemberKind}.String()
	KeyRingIamMemberKindAPIVersion   = KeyRingIamMemberKind + "." + GroupVersion.String()
	KeyRingIamMemberGroupVersionKind = GroupVersion.WithKind(KeyRingIamMemberKind)
)
