...
// GetTerraformResourceIDField returns Terraform identifier field for this CryptoKeyIamPolicy
func (tr *CryptoKeyIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
