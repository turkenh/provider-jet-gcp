...
// GetTerraformResourceIDField returns Terraform identifier field for this CryptoKeyIamMember
func (tr *CryptoKeyIamMember) GetTerraformResourceIDField() string {
	return "id"
}
