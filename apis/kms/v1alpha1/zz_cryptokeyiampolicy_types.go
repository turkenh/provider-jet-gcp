...
var (
	CryptoKeyIamPolicyKind             = "CryptoKeyIamPolicy"
	CryptoKeyIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: CryptoKeyIamPolicyKind}.String()
	CryptoKeyIamPolicyKindAPIVersion   = CryptoKeyIamPolicyKind + "." + GroupVersion.String()
	CryptoKeyIamPolicyGroupVersionKind = GroupVersion.WithKind(CryptoKeyIamPolicyKind)
)
