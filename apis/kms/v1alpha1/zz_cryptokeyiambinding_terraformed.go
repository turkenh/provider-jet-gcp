...
// GetTerraformResourceIDField returns Terraform identifier field for this CryptoKeyIamBinding
func (tr *CryptoKeyIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
