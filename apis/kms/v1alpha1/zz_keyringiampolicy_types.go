...
var (
	KeyRingIamPolicyKind             = "KeyRingIamPolicy"
	KeyRingIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: KeyRingIamPolicyKind}.String()
	KeyRingIamPolicyKindAPIVersion   = KeyRingIamPolicyKind + "." + GroupVersion.String()
	KeyRingIamPolicyGroupVersionKind = GroupVersion.WithKind(KeyRingIamPolicyKind)
)
