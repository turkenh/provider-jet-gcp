...
var (
	SecretCiphertextKind             = "SecretCiphertext"
	SecretCiphertextGroupKind        = schema.GroupKind{Group: Group, Kind: SecretCiphertextKind}.String()
	SecretCiphertextKindAPIVersion   = SecretCiphertextKind + "." + GroupVersion.String()
	SecretCiphertextGroupVersionKind = GroupVersion.WithKind(SecretCiphertextKind)
)
