...
var (
	CaPoolIamPolicyKind             = "CaPoolIamPolicy"
	CaPoolIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: CaPoolIamPolicyKind}.String()
	CaPoolIamPolicyKindAPIVersion   = CaPoolIamPolicyKind + "." + GroupVersion.String()
	CaPoolIamPolicyGroupVersionKind = GroupVersion.WithKind(CaPoolIamPolicyKind)
)
