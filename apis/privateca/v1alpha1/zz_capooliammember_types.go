...
var (
	CaPoolIamMemberKind             = "CaPoolIamMember"
	CaPoolIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: CaPoolIamMemberKind}.String()
	CaPoolIamMemberKindAPIVersion   = CaPoolIamMemberKind + "." + GroupVersion.String()
	CaPoolIamMemberGroupVersionKind = GroupVersion.WithKind(CaPoolIamMemberKind)
)
