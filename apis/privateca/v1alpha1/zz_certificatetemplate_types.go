...
var (
	CertificateTemplateKind             = "CertificateTemplate"
	CertificateTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: CertificateTemplateKind}.String()
	CertificateTemplateKindAPIVersion   = CertificateTemplateKind + "." + GroupVersion.String()
	CertificateTemplateGroupVersionKind = GroupVersion.WithKind(CertificateTemplateKind)
)
