...
// GetTerraformResourceIDField returns Terraform identifier field for this CertificateTemplate
func (tr *CertificateTemplate) GetTerraformResourceIDField() string {
	return "id"
}
