...
var (
	CaPoolKind             = "CaPool"
	CaPoolGroupKind        = schema.GroupKind{Group: Group, Kind: CaPoolKind}.String()
	CaPoolKindAPIVersion   = CaPoolKind + "." + GroupVersion.String()
	CaPoolGroupVersionKind = GroupVersion.WithKind(CaPoolKind)
)
