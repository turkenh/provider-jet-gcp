...
var (
	...
	FulfillmentGroupKind        = schema.GroupKind{Group: Group, Kind: FulfillmentKind}.String()
	FulfillmentKindAPIVersion   = FulfillmentKind + "." + GroupVersion.String()
	FulfillmentGroupVersionKind = GroupVersion.WithKind(FulfillmentKind)
)
