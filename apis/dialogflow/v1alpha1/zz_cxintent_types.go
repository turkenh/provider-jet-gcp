...
var (
	CxIntentKind             = "CxIntent"
	CxIntentGroupKind        = schema.GroupKind{Group: Group, Kind: CxIntentKind}.String()
	CxIntentKindAPIVersion   = CxIntentKind + "." + GroupVersion.String()
	CxIntentGroupVersionKind = GroupVersion.WithKind(CxIntentKind)
)
