...
var (
	CxFlowKind             = "CxFlow"
	CxFlowGroupKind        = schema.GroupKind{Group: Group, Kind: CxFlowKind}.String()
	CxFlowKindAPIVersion   = CxFlowKind + "." + GroupVersion.String()
	CxFlowGroupVersionKind = GroupVersion.WithKind(CxFlowKind)
)
