...
var (
	CxVersionKind             = "CxVersion"
	CxVersionGroupKind        = schema.GroupKind{Group: Group, Kind: CxVersionKind}.String()
	CxVersionKindAPIVersion   = CxVersionKind + "." + GroupVersion.String()
	CxVersionGroupVersionKind = GroupVersion.WithKind(CxVersionKind)
)
