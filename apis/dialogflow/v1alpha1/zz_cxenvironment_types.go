...
var (
	CxEnvironmentKind             = "CxEnvironment"
	CxEnvironmentGroupKind        = schema.GroupKind{Group: Group, Kind: CxEnvironmentKind}.String()
	CxEnvironmentKindAPIVersion   = CxEnvironmentKind + "." + GroupVersion.String()
	CxEnvironmentGroupVersionKind = GroupVersion.WithKind(CxEnvironmentKind)
)
