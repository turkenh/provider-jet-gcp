...
var (
	CxAgentKind             = "CxAgent"
	CxAgentGroupKind        = schema.GroupKind{Group: Group, Kind: CxAgentKind}.String()
	CxAgentKindAPIVersion   = CxAgentKind + "." + GroupVersion.String()
	CxAgentGroupVersionKind = GroupVersion.WithKind(CxAgentKind)
)
