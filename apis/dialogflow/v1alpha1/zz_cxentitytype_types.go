...
var (
	CxEntityTypeKind             = "CxEntityType"
	CxEntityTypeGroupKind        = schema.GroupKind{Group: Group, Kind: CxEntityTypeKind}.String()
	CxEntityTypeKindAPIVersion   = CxEntityTypeKind + "." + GroupVersion.String()
	CxEntityTypeGroupVersionKind = GroupVersion.WithKind(CxEntityTypeKind)
)
