...
var (
	EntityTypeKind             = "EntityType"
	EntityTypeGroupKind        = schema.GroupKind{Group: Group, Kind: EntityTypeKind}.String()
	EntityTypeKindAPIVersion   = EntityTypeKind + "." + GroupVersion.String()
	EntityTypeGroupVersionKind = GroupVersion.WithKind(EntityTypeKind)
)
