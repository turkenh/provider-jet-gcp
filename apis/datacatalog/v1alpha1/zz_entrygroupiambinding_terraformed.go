...
// GetTerraformResourceIDField returns Terraform identifier field for this EntryGroupIamBinding
func (tr *EntryGroupIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
