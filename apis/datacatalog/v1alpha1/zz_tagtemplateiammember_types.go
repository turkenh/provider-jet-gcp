...
var (
	TagTemplateIamMemberKind             = "TagTemplateIamMember"
	TagTemplateIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TagTemplateIamMemberKind}.String()
	TagTemplateIamMemberKindAPIVersion   = TagTemplateIamMemberKind + "." + GroupVersion.String()
	TagTemplateIamMemberGroupVersionKind = GroupVersion.WithKind(TagTemplateIamMemberKind)
)
