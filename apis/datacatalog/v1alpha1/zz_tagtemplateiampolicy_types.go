...
var (
	TagTemplateIamPolicyKind             = "TagTemplateIamPolicy"
	TagTemplateIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TagTemplateIamPolicyKind}.String()
	TagTemplateIamPolicyKindAPIVersion   = TagTemplateIamPolicyKind + "." + GroupVersion.String()
	TagTemplateIamPolicyGroupVersionKind = GroupVersion.WithKind(TagTemplateIamPolicyKind)
)
