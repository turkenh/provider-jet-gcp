...
var (
	TagTemplateKind             = "TagTemplate"
	TagTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: TagTemplateKind}.String()
	TagTemplateKindAPIVersion   = TagTemplateKind + "." + GroupVersion.String()
	TagTemplateGroupVersionKind = GroupVersion.WithKind(TagTemplateKind)
)
