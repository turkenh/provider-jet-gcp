...
var (
	EntryGroupIamBindingKind             = "EntryGroupIamBinding"
	EntryGroupIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: EntryGroupIamBindingKind}.String()
	EntryGroupIamBindingKindAPIVersion   = EntryGroupIamBindingKind + "." + GroupVersion.String()
	EntryGroupIamBindingGroupVersionKind = GroupVersion.WithKind(EntryGroupIamBindingKind)
)
