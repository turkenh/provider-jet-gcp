...
var (
	EntryGroupIamPolicyKind             = "EntryGroupIamPolicy"
	EntryGroupIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: EntryGroupIamPolicyKind}.String()
	EntryGroupIamPolicyKindAPIVersion   = EntryGroupIamPolicyKind + "." + GroupVersion.String()
	EntryGroupIamPolicyGroupVersionKind = GroupVersion.WithKind(EntryGroupIamPolicyKind)
)
