...
var (
	EntryGroupIamMemberKind             = "EntryGroupIamMember"
	EntryGroupIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: EntryGroupIamMemberKind}.String()
	EntryGroupIamMemberKindAPIVersion   = EntryGroupIamMemberKind + "." + GroupVersion.String()
	EntryGroupIamMemberGroupVersionKind = GroupVersion.WithKind(EntryGroupIamMemberKind)
)
