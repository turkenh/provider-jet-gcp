...
var (
	TagTemplateIamBindingKind             = "TagTemplateIamBinding"
	TagTemplateIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TagTemplateIamBindingKind}.String()
	TagTemplateIamBindingKindAPIVersion   = TagTemplateIamBindingKind + "." + GroupVersion.String()
	TagTemplateIamBindingGroupVersionKind = GroupVersion.WithKind(TagTemplateIamBindingKind)
)
