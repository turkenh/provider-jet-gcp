...
// GetTerraformResourceIDField returns Terraform identifier field for this EntryGroupIamMember
func (tr *EntryGroupIamMember) GetTerraformResourceIDField() string {
	return "id"
}
