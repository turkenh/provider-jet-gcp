...
// GetTerraformResourceIDField returns Terraform identifier field for this TagTemplateIamPolicy
func (tr *TagTemplateIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
