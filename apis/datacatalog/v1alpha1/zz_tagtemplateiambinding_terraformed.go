...
// GetTerraformResourceIDField returns Terraform identifier field for this TagTemplateIamBinding
func (tr *TagTemplateIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
