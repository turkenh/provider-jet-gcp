...
// GetTerraformResourceIDField returns Terraform identifier field for this TagTemplateIamMember
func (tr *TagTemplateIamMember) GetTerraformResourceIDField() string {
	return "id"
}
