...
// GetCondition of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) GetCondition(ct xpv1.ConditionType) xpv1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetProviderConfigReference of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) GetProviderConfigReference() *xpv1.Reference {
	return mg.Spec.ProviderConfigReference
}

/*
GetProviderReference of this DataCatalogEntryGroup.
Deprecated: Use GetProviderConfigReference.
*/
func (mg *DataCatalogEntryGroup) GetProviderReference() *xpv1.Reference {
	return mg.Spec.ProviderReference
}

// GetWriteConnectionSecretToReference of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetConditions of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) SetConditions(c ...xpv1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetProviderConfigReference of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}

/*
SetProviderReference of this DataCatalogEntryGroup.
Deprecated: Use SetProviderConfigReference.
*/
func (mg *DataCatalogEntryGroup) SetProviderReference(r *xpv1.Reference) {
	mg.Spec.ProviderReference = r
}

// SetWriteConnectionSecretToReference of this DataCatalogEntryGroup.
func (mg *DataCatalogEntryGroup) SetWriteConnectionSecretToReference(r *xpv1.SecretReference) {
