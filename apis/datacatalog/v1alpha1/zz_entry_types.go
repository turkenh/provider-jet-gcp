...
var (
	EntryKind             = "Entry"
	EntryGroupKind        = schema.GroupKind{Group: Group, Kind: EntryKind}.String()
	EntryKindAPIVersion   = EntryKind + "." + GroupVersion.String()
	EntryGroupVersionKind = GroupVersion.WithKind(EntryKind)
)
