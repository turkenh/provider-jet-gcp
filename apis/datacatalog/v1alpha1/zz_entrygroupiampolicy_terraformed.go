...
// GetTerraformResourceIDField returns Terraform identifier field for this EntryGroupIamPolicy
func (tr *EntryGroupIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
