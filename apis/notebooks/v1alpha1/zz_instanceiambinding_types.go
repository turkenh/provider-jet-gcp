...
var (
	InstanceIamBindingKind             = "InstanceIamBinding"
	InstanceIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceIamBindingKind}.String()
	InstanceIamBindingKindAPIVersion   = InstanceIamBindingKind + "." + GroupVersion.String()
	InstanceIamBindingGroupVersionKind = GroupVersion.WithKind(InstanceIamBindingKind)
)
