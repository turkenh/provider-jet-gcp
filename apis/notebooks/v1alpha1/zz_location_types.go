...
var (
	...
	LocationGroupKind        = schema.GroupKind{Group: Group, Kind: LocationKind}.String()
	LocationKindAPIVersion   = LocationKind + "." + GroupVersion.String()
	LocationGroupVersionKind = GroupVersion.WithKind(LocationKind)
)
