...
// GetTerraformResourceIDField returns Terraform identifier field for this InstanceIamBinding
func (tr *InstanceIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
