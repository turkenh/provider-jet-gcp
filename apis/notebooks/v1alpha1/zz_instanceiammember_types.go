...
var (
	InstanceIamMemberKind             = "InstanceIamMember"
	InstanceIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceIamMemberKind}.String()
	InstanceIamMemberKindAPIVersion   = InstanceIamMemberKind + "." + GroupVersion.String()
	InstanceIamMemberGroupVersionKind = GroupVersion.WithKind(InstanceIamMemberKind)
)
