...
var (
	LienKind             = "Lien"
	LienGroupKind        = schema.GroupKind{Group: Group, Kind: LienKind}.String()
	LienKindAPIVersion   = LienKind + "." + GroupVersion.String()
	LienGroupVersionKind = GroupVersion.WithKind(LienKind)
)
