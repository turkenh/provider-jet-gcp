...
var (
	SubscriptionIamMemberKind             = "SubscriptionIamMember"
	SubscriptionIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: SubscriptionIamMemberKind}.String()
	SubscriptionIamMemberKindAPIVersion   = SubscriptionIamMemberKind + "." + GroupVersion.String()
	SubscriptionIamMemberGroupVersionKind = GroupVersion.WithKind(SubscriptionIamMemberKind)
)
