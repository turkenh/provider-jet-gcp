...
var (
	LiteReservationKind             = "LiteReservation"
	LiteReservationGroupKind        = schema.GroupKind{Group: Group, Kind: LiteReservationKind}.String()
	LiteReservationKindAPIVersion   = LiteReservationKind + "." + GroupVersion.String()
	LiteReservationGroupVersionKind = GroupVersion.WithKind(LiteReservationKind)
)
