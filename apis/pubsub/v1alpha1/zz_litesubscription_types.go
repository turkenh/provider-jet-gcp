...
var (
	LiteSubscriptionKind             = "LiteSubscription"
	LiteSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: LiteSubscriptionKind}.String()
	LiteSubscriptionKindAPIVersion   = LiteSubscriptionKind + "." + GroupVersion.String()
	LiteSubscriptionGroupVersionKind = GroupVersion.WithKind(LiteSubscriptionKind)
)
