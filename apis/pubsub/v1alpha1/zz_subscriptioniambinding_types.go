...
var (
	SubscriptionIamBindingKind             = "SubscriptionIamBinding"
	SubscriptionIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: SubscriptionIamBindingKind}.String()
	SubscriptionIamBindingKindAPIVersion   = SubscriptionIamBindingKind + "." + GroupVersion.String()
	SubscriptionIamBindingGroupVersionKind = GroupVersion.WithKind(SubscriptionIamBindingKind)
)
