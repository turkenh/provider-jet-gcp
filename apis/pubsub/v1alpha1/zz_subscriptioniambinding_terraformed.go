...
// GetTerraformResourceIDField returns Terraform identifier field for this SubscriptionIamBinding
func (tr *SubscriptionIamBinding) GetTerraformResourceIDField() string {
	return "id"
}
