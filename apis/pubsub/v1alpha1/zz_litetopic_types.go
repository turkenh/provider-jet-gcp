...
var (
	LiteTopicKind             = "LiteTopic"
	LiteTopicGroupKind        = schema.GroupKind{Group: Group, Kind: LiteTopicKind}.String()
	LiteTopicKindAPIVersion   = LiteTopicKind + "." + GroupVersion.String()
	LiteTopicGroupVersionKind = GroupVersion.WithKind(LiteTopicKind)
)
