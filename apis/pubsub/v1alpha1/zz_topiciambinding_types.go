...
var (
	TopicIamBindingKind             = "TopicIamBinding"
	TopicIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: TopicIamBindingKind}.String()
	TopicIamBindingKindAPIVersion   = TopicIamBindingKind + "." + GroupVersion.String()
	TopicIamBindingGroupVersionKind = GroupVersion.WithKind(TopicIamBindingKind)
)
