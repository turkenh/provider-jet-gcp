...
var (
	SubscriptionIamPolicyKind             = "SubscriptionIamPolicy"
	SubscriptionIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SubscriptionIamPolicyKind}.String()
	SubscriptionIamPolicyKindAPIVersion   = SubscriptionIamPolicyKind + "." + GroupVersion.String()
	SubscriptionIamPolicyGroupVersionKind = GroupVersion.WithKind(SubscriptionIamPolicyKind)
)
