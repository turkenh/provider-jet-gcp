...
// GetTerraformResourceIDField returns Terraform identifier field for this SubscriptionIamMember
func (tr *SubscriptionIamMember) GetTerraformResourceIDField() string {
	return "id"
}
