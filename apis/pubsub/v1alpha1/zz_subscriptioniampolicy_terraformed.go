...
// GetTerraformResourceIDField returns Terraform identifier field for this SubscriptionIamPolicy
func (tr *SubscriptionIamPolicy) GetTerraformResourceIDField() string {
	return "id"
}
