...
var (
	TopicIamMemberKind             = "TopicIamMember"
	TopicIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: TopicIamMemberKind}.String()
	TopicIamMemberKindAPIVersion   = TopicIamMemberKind + "." + GroupVersion.String()
	TopicIamMemberGroupVersionKind = GroupVersion.WithKind(TopicIamMemberKind)
)
