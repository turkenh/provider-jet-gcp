...
var (
	TopicIamPolicyKind             = "TopicIamPolicy"
	TopicIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TopicIamPolicyKind}.String()
	TopicIamPolicyKindAPIVersion   = TopicIamPolicyKind + "." + GroupVersion.String()
	TopicIamPolicyGroupVersionKind = GroupVersion.WithKind(TopicIamPolicyKind)
)
