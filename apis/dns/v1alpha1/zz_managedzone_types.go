...
var (
	ManagedZoneKind             = "ManagedZone"
	ManagedZoneGroupKind        = schema.GroupKind{Group: Group, Kind: ManagedZoneKind}.String()
	ManagedZoneKindAPIVersion   = ManagedZoneKind + "." + GroupVersion.String()
	ManagedZoneGroupVersionKind = GroupVersion.WithKind(ManagedZoneKind)
)
