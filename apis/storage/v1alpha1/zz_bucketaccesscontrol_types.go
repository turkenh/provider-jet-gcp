...
var (
	BucketAccessControlKind             = "BucketAccessControl"
	BucketAccessControlGroupKind        = schema.GroupKind{Group: Group, Kind: BucketAccessControlKind}.String()
	BucketAccessControlKindAPIVersion   = BucketAccessControlKind + "." + GroupVersion.String()
	BucketAccessControlGroupVersionKind = GroupVersion.WithKind(BucketAccessControlKind)
)
