...
var (
	DefaultObjectAccessControlKind             = "DefaultObjectAccessControl"
	DefaultObjectAccessControlGroupKind        = schema.GroupKind{Group: Group, Kind: DefaultObjectAccessControlKind}.String()
	DefaultObjectAccessControlKindAPIVersion   = DefaultObjectAccessControlKind + "." + GroupVersion.String()
	DefaultObjectAccessControlGroupVersionKind = GroupVersion.WithKind(DefaultObjectAccessControlKind)
)
