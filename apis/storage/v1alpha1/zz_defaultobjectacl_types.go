...
var (
	DefaultObjectAclKind             = "DefaultObjectAcl"
	DefaultObjectAclGroupKind        = schema.GroupKind{Group: Group, Kind: DefaultObjectAclKind}.String()
	DefaultObjectAclKindAPIVersion   = DefaultObjectAclKind + "." + GroupVersion.String()
	DefaultObjectAclGroupVersionKind = GroupVersion.WithKind(DefaultObjectAclKind)
)
