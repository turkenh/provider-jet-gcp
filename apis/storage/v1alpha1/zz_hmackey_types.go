...
var (
	HmacKeyKind             = "HmacKey"
	HmacKeyGroupKind        = schema.GroupKind{Group: Group, Kind: HmacKeyKind}.String()
	HmacKeyKindAPIVersion   = HmacKeyKind + "." + GroupVersion.String()
	HmacKeyGroupVersionKind = GroupVersion.WithKind(HmacKeyKind)
)
