...
var (
	BucketIamMemberKind             = "BucketIamMember"
	BucketIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: BucketIamMemberKind}.String()
	BucketIamMemberKindAPIVersion   = BucketIamMemberKind + "." + GroupVersion.String()
	BucketIamMemberGroupVersionKind = GroupVersion.WithKind(BucketIamMemberKind)
)
