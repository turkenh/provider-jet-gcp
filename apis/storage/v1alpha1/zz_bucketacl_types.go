...
var (
	BucketAclKind             = "BucketAcl"
	BucketAclGroupKind        = schema.GroupKind{Group: Group, Kind: BucketAclKind}.String()
	BucketAclKindAPIVersion   = BucketAclKind + "." + GroupVersion.String()
	BucketAclGroupVersionKind = GroupVersion.WithKind(BucketAclKind)
)
