...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketAccessControl
func (tr *BucketAccessControl) GetTerraformResourceIDField() string {
	return "id"
}
