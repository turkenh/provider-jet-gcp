...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultObjectAccessControl
func (tr *DefaultObjectAccessControl) GetTerraformResourceIDField() string {
	return "id"
}
