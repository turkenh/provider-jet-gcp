...
// GetTerraformResourceIDField returns Terraform identifier field for this ObjectAccessControl
func (tr *ObjectAccessControl) GetTerraformResourceIDField() string {
	return "id"
}
