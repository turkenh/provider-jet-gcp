...
var (
	TransferJobKind             = "TransferJob"
	TransferJobGroupKind        = schema.GroupKind{Group: Group, Kind: TransferJobKind}.String()
	TransferJobKindAPIVersion   = TransferJobKind + "." + GroupVersion.String()
	TransferJobGroupVersionKind = GroupVersion.WithKind(TransferJobKind)
)
