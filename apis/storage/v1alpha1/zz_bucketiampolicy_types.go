...
var (
	BucketIamPolicyKind             = "BucketIamPolicy"
	BucketIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: BucketIamPolicyKind}.String()
	BucketIamPolicyKindAPIVersion   = BucketIamPolicyKind + "." + GroupVersion.String()
	BucketIamPolicyGroupVersionKind = GroupVersion.WithKind(BucketIamPolicyKind)
)
