...
var (
	ObjectAclKind             = "ObjectAcl"
	ObjectAclGroupKind        = schema.GroupKind{Group: Group, Kind: ObjectAclKind}.String()
	ObjectAclKindAPIVersion   = ObjectAclKind + "." + GroupVersion.String()
	ObjectAclGroupVersionKind = GroupVersion.WithKind(ObjectAclKind)
)
