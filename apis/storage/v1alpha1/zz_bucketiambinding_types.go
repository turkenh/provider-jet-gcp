...
var (
	BucketIamBindingKind             = "BucketIamBinding"
	BucketIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: BucketIamBindingKind}.String()
	BucketIamBindingKindAPIVersion   = BucketIamBindingKind + "." + GroupVersion.String()
	BucketIamBindingGroupVersionKind = GroupVersion.WithKind(BucketIamBindingKind)
)
