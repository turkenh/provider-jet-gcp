...
var (
	ObjectAccessControlKind             = "ObjectAccessControl"
	ObjectAccessControlGroupKind        = schema.GroupKind{Group: Group, Kind: ObjectAccessControlKind}.String()
	ObjectAccessControlKindAPIVersion   = ObjectAccessControlKind + "." + GroupVersion.String()
	ObjectAccessControlGroupVersionKind = GroupVersion.WithKind(ObjectAccessControlKind)
)
