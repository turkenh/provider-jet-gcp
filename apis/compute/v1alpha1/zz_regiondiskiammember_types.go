...
var (
	RegionDiskIamMemberKind             = "RegionDiskIamMember"
	RegionDiskIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: RegionDiskIamMemberKind}.String()
	RegionDiskIamMemberKindAPIVersion   = RegionDiskIamMemberKind + "." + GroupVersion.String()
	RegionDiskIamMemberGroupVersionKind = GroupVersion.WithKind(RegionDiskIamMemberKind)
)
