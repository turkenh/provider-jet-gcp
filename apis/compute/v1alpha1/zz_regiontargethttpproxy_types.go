...
var (
	RegionTargetHttpProxyKind             = "RegionTargetHttpProxy"
	RegionTargetHttpProxyGroupKind        = schema.GroupKind{Group: Group, Kind: RegionTargetHttpProxyKind}.String()
	RegionTargetHttpProxyKindAPIVersion   = RegionTargetHttpProxyKind + "." + GroupVersion.String()
	RegionTargetHttpProxyGroupVersionKind = GroupVersion.WithKind(RegionTargetHttpProxyKind)
)
