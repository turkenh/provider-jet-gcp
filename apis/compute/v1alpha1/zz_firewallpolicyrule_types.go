...
var (
	FirewallPolicyRuleKind             = "FirewallPolicyRule"
	FirewallPolicyRuleGroupKind        = schema.GroupKind{Group: Group, Kind: FirewallPolicyRuleKind}.String()
	FirewallPolicyRuleKindAPIVersion   = FirewallPolicyRuleKind + "." + GroupVersion.String()
	FirewallPolicyRuleGroupVersionKind = GroupVersion.WithKind(FirewallPolicyRuleKind)
)
