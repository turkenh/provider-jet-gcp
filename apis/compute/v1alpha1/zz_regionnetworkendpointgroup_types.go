...
var (
	RegionNetworkEndpointGroupKind             = "RegionNetworkEndpointGroup"
	RegionNetworkEndpointGroupGroupKind        = schema.GroupKind{Group: Group, Kind: RegionNetworkEndpointGroupKind}.String()
	RegionNetworkEndpointGroupKindAPIVersion   = RegionNetworkEndpointGroupKind + "." + GroupVersion.String()
	RegionNetworkEndpointGroupGroupVersionKind = GroupVersion.WithKind(RegionNetworkEndpointGroupKind)
)
