...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectMetadataItem
func (tr *ProjectMetadataItem) GetTerraformResourceIDField() string {
	return "id"
}
