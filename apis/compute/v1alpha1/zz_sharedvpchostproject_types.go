...
var (
	SharedVpcHostProjectKind             = "SharedVpcHostProject"
	SharedVpcHostProjectGroupKind        = schema.GroupKind{Group: Group, Kind: SharedVpcHostProjectKind}.String()
	SharedVpcHostProjectKindAPIVersion   = SharedVpcHostProjectKind + "." + GroupVersion.String()
	SharedVpcHostProjectGroupVersionKind = GroupVersion.WithKind(SharedVpcHostProjectKind)
)
