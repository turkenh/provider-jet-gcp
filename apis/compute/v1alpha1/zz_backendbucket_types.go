...
var (
	BackendBucketKind             = "BackendBucket"
	BackendBucketGroupKind        = schema.GroupKind{Group: Group, Kind: BackendBucketKind}.String()
	BackendBucketKindAPIVersion   = BackendBucketKind + "." + GroupVersion.String()
	BackendBucketGroupVersionKind = GroupVersion.WithKind(BackendBucketKind)
)
