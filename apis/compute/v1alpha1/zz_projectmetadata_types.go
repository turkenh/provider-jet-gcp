...
var (
	ProjectMetadataKind             = "ProjectMetadata"
	ProjectMetadataGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectMetadataKind}.String()
	ProjectMetadataKindAPIVersion   = ProjectMetadataKind + "." + GroupVersion.String()
	ProjectMetadataGroupVersionKind = GroupVersion.WithKind(ProjectMetadataKind)
)
