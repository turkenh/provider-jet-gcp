...
var (
	RegionHealthCheckKind             = "RegionHealthCheck"
	RegionHealthCheckGroupKind        = schema.GroupKind{Group: Group, Kind: RegionHealthCheckKind}.String()
	RegionHealthCheckKindAPIVersion   = RegionHealthCheckKind + "." + GroupVersion.String()
	RegionHealthCheckGroupVersionKind = GroupVersion.WithKind(RegionHealthCheckKind)
)
