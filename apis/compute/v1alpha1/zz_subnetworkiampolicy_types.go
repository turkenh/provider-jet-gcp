...
var (
	SubnetworkIamPolicyKind             = "SubnetworkIamPolicy"
	SubnetworkIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: SubnetworkIamPolicyKind}.String()
	SubnetworkIamPolicyKindAPIVersion   = SubnetworkIamPolicyKind + "." + GroupVersion.String()
	SubnetworkIamPolicyGroupVersionKind = GroupVersion.WithKind(SubnetworkIamPolicyKind)
)
