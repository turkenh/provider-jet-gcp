...
// GetTerraformResourceIDField returns Terraform identifier field for this FirewallPolicyRule
func (tr *FirewallPolicyRule) GetTerraformResourceIDField() string {
	return "id"
}
