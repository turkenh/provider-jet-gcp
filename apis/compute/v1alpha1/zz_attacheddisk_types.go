...
var (
	AttachedDiskKind             = "AttachedDisk"
	AttachedDiskGroupKind        = schema.GroupKind{Group: Group, Kind: AttachedDiskKind}.String()
	AttachedDiskKindAPIVersion   = AttachedDiskKind + "." + GroupVersion.String()
	AttachedDiskGroupVersionKind = GroupVersion.WithKind(AttachedDiskKind)
)
