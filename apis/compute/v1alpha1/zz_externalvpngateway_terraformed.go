...
// GetTerraformResourceIDField returns Terraform identifier field for this ExternalVpnGateway
func (tr *ExternalVpnGateway) GetTerraformResourceIDField() string {
	return "id"
}
