...
var (
	TargetPoolKind             = "TargetPool"
	TargetPoolGroupKind        = schema.GroupKind{Group: Group, Kind: TargetPoolKind}.String()
	TargetPoolKindAPIVersion   = TargetPoolKind + "." + GroupVersion.String()
	TargetPoolGroupVersionKind = GroupVersion.WithKind(TargetPoolKind)
)
