...
var (
	TargetInstanceKind             = "TargetInstance"
	TargetInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: TargetInstanceKind}.String()
	TargetInstanceKindAPIVersion   = TargetInstanceKind + "." + GroupVersion.String()
	TargetInstanceGroupVersionKind = GroupVersion.WithKind(TargetInstanceKind)
)
