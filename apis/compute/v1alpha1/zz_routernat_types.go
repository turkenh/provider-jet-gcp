...
var (
	RouterNatKind             = "RouterNat"
	RouterNatGroupKind        = schema.GroupKind{Group: Group, Kind: RouterNatKind}.String()
	RouterNatKindAPIVersion   = RouterNatKind + "." + GroupVersion.String()
	RouterNatGroupVersionKind = GroupVersion.WithKind(RouterNatKind)
)
