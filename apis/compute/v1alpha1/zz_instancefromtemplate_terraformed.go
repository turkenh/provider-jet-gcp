...
// GetTerraformResourceIDField returns Terraform identifier field for this InstanceFromTemplate
func (tr *InstanceFromTemplate) GetTerraformResourceIDField() string {
	return "id"
}
