...
// GetTerraformResourceIDField returns Terraform identifier field for this InterconnectAttachment
func (tr *InterconnectAttachment) GetTerraformResourceIDField() string {
	return "id"
}
