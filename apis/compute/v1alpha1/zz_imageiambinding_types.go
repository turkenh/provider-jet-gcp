...
var (
	ImageIamBindingKind             = "ImageIamBinding"
	ImageIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: ImageIamBindingKind}.String()
	ImageIamBindingKindAPIVersion   = ImageIamBindingKind + "." + GroupVersion.String()
	ImageIamBindingGroupVersionKind = GroupVersion.WithKind(ImageIamBindingKind)
)
