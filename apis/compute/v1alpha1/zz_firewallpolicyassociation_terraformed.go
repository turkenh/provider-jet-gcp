...
// GetTerraformResourceIDField returns Terraform identifier field for this FirewallPolicyAssociation
func (tr *FirewallPolicyAssociation) GetTerraformResourceIDField() string {
	return "id"
}
