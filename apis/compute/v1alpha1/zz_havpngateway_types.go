...
var (
	HaVpnGatewayKind             = "HaVpnGateway"
	HaVpnGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: HaVpnGatewayKind}.String()
	HaVpnGatewayKindAPIVersion   = HaVpnGatewayKind + "." + GroupVersion.String()
	HaVpnGatewayGroupVersionKind = GroupVersion.WithKind(HaVpnGatewayKind)
)
