...
var (
	TargetGrpcProxyKind             = "TargetGrpcProxy"
	TargetGrpcProxyGroupKind        = schema.GroupKind{Group: Group, Kind: TargetGrpcProxyKind}.String()
	TargetGrpcProxyKindAPIVersion   = TargetGrpcProxyKind + "." + GroupVersion.String()
	TargetGrpcProxyGroupVersionKind = GroupVersion.WithKind(TargetGrpcProxyKind)
)
