...
var (
	ForwardingRuleKind             = "ForwardingRule"
	ForwardingRuleGroupKind        = schema.GroupKind{Group: Group, Kind: ForwardingRuleKind}.String()
	ForwardingRuleKindAPIVersion   = ForwardingRuleKind + "." + GroupVersion.String()
	ForwardingRuleGroupVersionKind = GroupVersion.WithKind(ForwardingRuleKind)
)
