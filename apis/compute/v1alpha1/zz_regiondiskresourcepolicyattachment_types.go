...
var (
	RegionDiskResourcePolicyAttachmentKind             = "RegionDiskResourcePolicyAttachment"
	RegionDiskResourcePolicyAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: RegionDiskResourcePolicyAttachmentKind}.String()
	RegionDiskResourcePolicyAttachmentKindAPIVersion   = RegionDiskResourcePolicyAttachmentKind + "." + GroupVersion.String()
	RegionDiskResourcePolicyAttachmentGroupVersionKind = GroupVersion.WithKind(RegionDiskResourcePolicyAttachmentKind)
)
