...
var (
	TargetTcpProxyKind             = "TargetTcpProxy"
	TargetTcpProxyGroupKind        = schema.GroupKind{Group: Group, Kind: TargetTcpProxyKind}.String()
	TargetTcpProxyKindAPIVersion   = TargetTcpProxyKind + "." + GroupVersion.String()
	TargetTcpProxyGroupVersionKind = GroupVersion.WithKind(TargetTcpProxyKind)
)
