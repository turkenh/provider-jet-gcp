...
// GetTerraformResourceIDField returns Terraform identifier field for this BackendServiceSignedUrlKey
func (tr *BackendServiceSignedUrlKey) GetTerraformResourceIDField() string {
	return "id"
}
