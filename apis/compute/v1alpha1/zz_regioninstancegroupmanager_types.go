...
var (
	RegionInstanceGroupManagerKind             = "RegionInstanceGroupManager"
	RegionInstanceGroupManagerGroupKind        = schema.GroupKind{Group: Group, Kind: RegionInstanceGroupManagerKind}.String()
	RegionInstanceGroupManagerKindAPIVersion   = RegionInstanceGroupManagerKind + "." + GroupVersion.String()
	RegionInstanceGroupManagerGroupVersionKind = GroupVersion.WithKind(RegionInstanceGroupManagerKind)
)
