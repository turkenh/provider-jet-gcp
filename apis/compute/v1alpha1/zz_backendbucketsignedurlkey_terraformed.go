...
// GetTerraformResourceIDField returns Terraform identifier field for this BackendBucketSignedUrlKey
func (tr *BackendBucketSignedUrlKey) GetTerraformResourceIDField() string {
	return "id"
}
