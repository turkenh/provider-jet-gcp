...
var (
	ProjectDefaultNetworkTierKind             = "ProjectDefaultNetworkTier"
	ProjectDefaultNetworkTierGroupKind        = schema.GroupKind{Group: Group, Kind: ProjectDefaultNetworkTierKind}.String()
	ProjectDefaultNetworkTierKindAPIVersion   = ProjectDefaultNetworkTierKind + "." + GroupVersion.String()
	ProjectDefaultNetworkTierGroupVersionKind = GroupVersion.WithKind(ProjectDefaultNetworkTierKind)
)
