...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionInstanceGroupManager
func (tr *RegionInstanceGroupManager) GetTerraformResourceIDField() string {
	return "id"
}
