...
var (
	RegionTargetHttpsProxyKind             = "RegionTargetHttpsProxy"
	RegionTargetHttpsProxyGroupKind        = schema.GroupKind{Group: Group, Kind: RegionTargetHttpsProxyKind}.String()
	RegionTargetHttpsProxyKindAPIVersion   = RegionTargetHttpsProxyKind + "." + GroupVersion.String()
	RegionTargetHttpsProxyGroupVersionKind = GroupVersion.WithKind(RegionTargetHttpsProxyKind)
)
