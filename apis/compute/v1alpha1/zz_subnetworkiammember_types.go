...
var (
	SubnetworkIamMemberKind             = "SubnetworkIamMember"
	SubnetworkIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: SubnetworkIamMemberKind}.String()
	SubnetworkIamMemberKindAPIVersion   = SubnetworkIamMemberKind + "." + GroupVersion.String()
	SubnetworkIamMemberGroupVersionKind = GroupVersion.WithKind(SubnetworkIamMemberKind)
)
