...
var (
	RouterPeerKind             = "RouterPeer"
	RouterPeerGroupKind        = schema.GroupKind{Group: Group, Kind: RouterPeerKind}.String()
	RouterPeerKindAPIVersion   = RouterPeerKind + "." + GroupVersion.String()
	RouterPeerGroupVersionKind = GroupVersion.WithKind(RouterPeerKind)
)
