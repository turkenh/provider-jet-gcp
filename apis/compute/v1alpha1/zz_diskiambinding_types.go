...
var (
	DiskIamBindingKind             = "DiskIamBinding"
	DiskIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: DiskIamBindingKind}.String()
	DiskIamBindingKindAPIVersion   = DiskIamBindingKind + "." + GroupVersion.String()
	DiskIamBindingGroupVersionKind = GroupVersion.WithKind(DiskIamBindingKind)
)
