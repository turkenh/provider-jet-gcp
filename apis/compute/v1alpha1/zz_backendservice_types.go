...
var (
	BackendServiceKind             = "BackendService"
	BackendServiceGroupKind        = schema.GroupKind{Group: Group, Kind: BackendServiceKind}.String()
	BackendServiceKindAPIVersion   = BackendServiceKind + "." + GroupVersion.String()
	BackendServiceGroupVersionKind = GroupVersion.WithKind(BackendServiceKind)
)
