...
var (
	InstanceGroupManagerKind             = "InstanceGroupManager"
	InstanceGroupManagerGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceGroupManagerKind}.String()
	InstanceGroupManagerKindAPIVersion   = InstanceGroupManagerKind + "." + GroupVersion.String()
	InstanceGroupManagerGroupVersionKind = GroupVersion.WithKind(InstanceGroupManagerKind)
)
