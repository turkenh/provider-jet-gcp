...
var (
	GlobalForwardingRuleKind             = "GlobalForwardingRule"
	GlobalForwardingRuleGroupKind        = schema.GroupKind{Group: Group, Kind: GlobalForwardingRuleKind}.String()
	GlobalForwardingRuleKindAPIVersion   = GlobalForwardingRuleKind + "." + GroupVersion.String()
	GlobalForwardingRuleGroupVersionKind = GroupVersion.WithKind(GlobalForwardingRuleKind)
)
