...
var (
	NetworkEndpointKind             = "NetworkEndpoint"
	NetworkEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkEndpointKind}.String()
	NetworkEndpointKindAPIVersion   = NetworkEndpointKind + "." + GroupVersion.String()
	NetworkEndpointGroupVersionKind = GroupVersion.WithKind(NetworkEndpointKind)
)
