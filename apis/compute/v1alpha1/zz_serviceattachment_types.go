...
var (
	...
	ServiceAttachmentKindAPIVersion   = ServiceAttachmentKind + "." + GroupVersion.String()
	ServiceAttachmentGroupVersionKind = GroupVersion.WithKind(ServiceAttachmentKind)
)
