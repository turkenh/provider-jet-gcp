...
var (
	ExternalVpnGatewayKind             = "ExternalVpnGateway"
	ExternalVpnGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: ExternalVpnGatewayKind}.String()
	ExternalVpnGatewayKindAPIVersion   = ExternalVpnGatewayKind + "." + GroupVersion.String()
	ExternalVpnGatewayGroupVersionKind = GroupVersion.WithKind(ExternalVpnGatewayKind)
)
