...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionBackendService
func (tr *RegionBackendService) GetTerraformResourceIDField() string {
	return "id"
}
