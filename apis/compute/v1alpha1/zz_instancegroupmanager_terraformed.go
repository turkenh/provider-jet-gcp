...
// GetTerraformResourceIDField returns Terraform identifier field for this InstanceGroupManager
func (tr *InstanceGroupManager) GetTerraformResourceIDField() string {
	return "id"
}
