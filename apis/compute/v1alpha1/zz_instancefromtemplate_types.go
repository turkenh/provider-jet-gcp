...
var (
	InstanceFromTemplateKind             = "InstanceFromTemplate"
	InstanceFromTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceFromTemplateKind}.String()
	InstanceFromTemplateKindAPIVersion   = InstanceFromTemplateKind + "." + GroupVersion.String()
	InstanceFromTemplateGroupVersionKind = GroupVersion.WithKind(InstanceFromTemplateKind)
)
