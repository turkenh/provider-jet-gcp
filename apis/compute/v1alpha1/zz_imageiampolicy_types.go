...
var (
	ImageIamPolicyKind             = "ImageIamPolicy"
	ImageIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ImageIamPolicyKind}.String()
	ImageIamPolicyKindAPIVersion   = ImageIamPolicyKind + "." + GroupVersion.String()
	ImageIamPolicyGroupVersionKind = GroupVersion.WithKind(ImageIamPolicyKind)
)
