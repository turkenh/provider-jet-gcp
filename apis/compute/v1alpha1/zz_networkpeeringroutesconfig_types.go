...
var (
	NetworkPeeringRoutesConfigKind             = "NetworkPeeringRoutesConfig"
	NetworkPeeringRoutesConfigGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkPeeringRoutesConfigKind}.String()
	NetworkPeeringRoutesConfigKindAPIVersion   = NetworkPeeringRoutesConfigKind + "." + GroupVersion.String()
	NetworkPeeringRoutesConfigGroupVersionKind = GroupVersion.WithKind(NetworkPeeringRoutesConfigKind)
)
