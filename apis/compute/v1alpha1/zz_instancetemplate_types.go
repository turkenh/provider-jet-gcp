...
var (
	InstanceTemplateKind             = "InstanceTemplate"
	InstanceTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceTemplateKind}.String()
	InstanceTemplateKindAPIVersion   = InstanceTemplateKind + "." + GroupVersion.String()
	InstanceTemplateGroupVersionKind = GroupVersion.WithKind(InstanceTemplateKind)
)
