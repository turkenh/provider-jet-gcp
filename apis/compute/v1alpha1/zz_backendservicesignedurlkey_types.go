...
var (
	BackendServiceSignedUrlKeyKind             = "BackendServiceSignedUrlKey"
	BackendServiceSignedUrlKeyGroupKind        = schema.GroupKind{Group: Group, Kind: BackendServiceSignedUrlKeyKind}.String()
	BackendServiceSignedUrlKeyKindAPIVersion   = BackendServiceSignedUrlKeyKind + "." + GroupVersion.String()
	BackendServiceSignedUrlKeyGroupVersionKind = GroupVersion.WithKind(BackendServiceSignedUrlKeyKind)
)
