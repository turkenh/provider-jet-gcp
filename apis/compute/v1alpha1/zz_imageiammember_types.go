...
var (
	ImageIamMemberKind             = "ImageIamMember"
	ImageIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: ImageIamMemberKind}.String()
	ImageIamMemberKindAPIVersion   = ImageIamMemberKind + "." + GroupVersion.String()
	ImageIamMemberGroupVersionKind = GroupVersion.WithKind(ImageIamMemberKind)
)
