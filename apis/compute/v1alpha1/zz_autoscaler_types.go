...
var (
	...
	AutoscalerGroupKind        = schema.GroupKind{Group: Group, Kind: AutoscalerKind}.String()
	AutoscalerKindAPIVersion   = AutoscalerKind + "." + GroupVersion.String()
	AutoscalerGroupVersionKind = GroupVersion.WithKind(AutoscalerKind)
)
