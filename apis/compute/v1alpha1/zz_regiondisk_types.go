...
var (
	RegionDiskKind             = "RegionDisk"
	RegionDiskGroupKind        = schema.GroupKind{Group: Group, Kind: RegionDiskKind}.String()
	RegionDiskKindAPIVersion   = RegionDiskKind + "." + GroupVersion.String()
	RegionDiskGroupVersionKind = GroupVersion.WithKind(RegionDiskKind)
)
