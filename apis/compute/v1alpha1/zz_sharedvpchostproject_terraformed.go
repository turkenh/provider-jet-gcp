...
// GetTerraformResourceIDField returns Terraform identifier field for this SharedVpcHostProject
func (tr *SharedVpcHostProject) GetTerraformResourceIDField() string {
	return "id"
}
