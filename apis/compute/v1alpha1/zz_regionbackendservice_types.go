...
var (
	RegionBackendServiceKind             = "RegionBackendService"
	RegionBackendServiceGroupKind        = schema.GroupKind{Group: Group, Kind: RegionBackendServiceKind}.String()
	RegionBackendServiceKindAPIVersion   = RegionBackendServiceKind + "." + GroupVersion.String()
	RegionBackendServiceGroupVersionKind = GroupVersion.WithKind(RegionBackendServiceKind)
)
