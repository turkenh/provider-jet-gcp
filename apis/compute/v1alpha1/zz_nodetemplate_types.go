...
var (
	...
	NodeTemplateGroupKind        = schema.GroupKind{Group: Group, Kind: NodeTemplateKind}.String()
	NodeTemplateKindAPIVersion   = NodeTemplateKind + "." + GroupVersion.String()
	NodeTemplateGroupVersionKind = GroupVersion.WithKind(NodeTemplateKind)
)
