...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionPerInstanceConfig
func (tr *RegionPerInstanceConfig) GetTerraformResourceIDField() string {
	return "id"
}
