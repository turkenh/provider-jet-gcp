...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionDiskIamMember
func (tr *RegionDiskIamMember) GetTerraformResourceIDField() string {
	return "id"
}
