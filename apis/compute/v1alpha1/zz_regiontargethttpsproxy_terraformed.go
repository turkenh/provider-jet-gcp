...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionTargetHttpsProxy
func (tr *RegionTargetHttpsProxy) GetTerraformResourceIDField() string {
	return "id"
}
