...
var (
	UrlMapKind             = "UrlMap"
	UrlMapGroupKind        = schema.GroupKind{Group: Group, Kind: UrlMapKind}.String()
	UrlMapKindAPIVersion   = UrlMapKind + "." + GroupVersion.String()
	UrlMapGroupVersionKind = GroupVersion.WithKind(UrlMapKind)
)
