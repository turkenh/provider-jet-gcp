...
var (
	TargetHttpProxyKind             = "TargetHttpProxy"
	TargetHttpProxyGroupKind        = schema.GroupKind{Group: Group, Kind: TargetHttpProxyKind}.String()
	TargetHttpProxyKindAPIVersion   = TargetHttpProxyKind + "." + GroupVersion.String()
	TargetHttpProxyGroupVersionKind = GroupVersion.WithKind(TargetHttpProxyKind)
)
