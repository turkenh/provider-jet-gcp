...
var (
	DiskResourcePolicyAttachmentKind             = "DiskResourcePolicyAttachment"
	DiskResourcePolicyAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: DiskResourcePolicyAttachmentKind}.String()
	DiskResourcePolicyAttachmentKindAPIVersion   = DiskResourcePolicyAttachmentKind + "." + GroupVersion.String()
	DiskResourcePolicyAttachmentGroupVersionKind = GroupVersion.WithKind(DiskResourcePolicyAttachmentKind)
)
