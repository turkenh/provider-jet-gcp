...
var (
	HttpHealthCheckKind             = "HttpHealthCheck"
	HttpHealthCheckGroupKind        = schema.GroupKind{Group: Group, Kind: HttpHealthCheckKind}.String()
	HttpHealthCheckKindAPIVersion   = HttpHealthCheckKind + "." + GroupVersion.String()
	HttpHealthCheckGroupVersionKind = GroupVersion.WithKind(HttpHealthCheckKind)
)
