...
var (
	DiskIamPolicyKind             = "DiskIamPolicy"
	DiskIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: DiskIamPolicyKind}.String()
	DiskIamPolicyKindAPIVersion   = DiskIamPolicyKind + "." + GroupVersion.String()
	DiskIamPolicyGroupVersionKind = GroupVersion.WithKind(DiskIamPolicyKind)
)
