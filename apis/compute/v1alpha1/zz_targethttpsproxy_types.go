...
var (
	TargetHttpsProxyKind             = "TargetHttpsProxy"
	TargetHttpsProxyGroupKind        = schema.GroupKind{Group: Group, Kind: TargetHttpsProxyKind}.String()
	TargetHttpsProxyKindAPIVersion   = TargetHttpsProxyKind + "." + GroupVersion.String()
	TargetHttpsProxyGroupVersionKind = GroupVersion.WithKind(TargetHttpsProxyKind)
)
