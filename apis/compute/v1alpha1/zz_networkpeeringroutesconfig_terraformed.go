...
// GetTerraformResourceIDField returns Terraform identifier field for this NetworkPeeringRoutesConfig
func (tr *NetworkPeeringRoutesConfig) GetTerraformResourceIDField() string {
	return "id"
}
