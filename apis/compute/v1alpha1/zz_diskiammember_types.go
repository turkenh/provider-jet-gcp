...
var (
	DiskIamMemberKind             = "DiskIamMember"
	DiskIamMemberGroupKind        = schema.GroupKind{Group: Group, Kind: DiskIamMemberKind}.String()
	DiskIamMemberKindAPIVersion   = DiskIamMemberKind + "." + GroupVersion.String()
	DiskIamMemberGroupVersionKind = GroupVersion.WithKind(DiskIamMemberKind)
)
