...
var (
	RegionAutoscalerKind             = "RegionAutoscaler"
	RegionAutoscalerGroupKind        = schema.GroupKind{Group: Group, Kind: RegionAutoscalerKind}.String()
	RegionAutoscalerKindAPIVersion   = RegionAutoscalerKind + "." + GroupVersion.String()
	RegionAutoscalerGroupVersionKind = GroupVersion.WithKind(RegionAutoscalerKind)
)
