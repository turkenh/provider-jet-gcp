...
var (
	SubnetworkIamBindingKind             = "SubnetworkIamBinding"
	SubnetworkIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: SubnetworkIamBindingKind}.String()
	SubnetworkIamBindingKindAPIVersion   = SubnetworkIamBindingKind + "." + GroupVersion.String()
	SubnetworkIamBindingGroupVersionKind = GroupVersion.WithKind(SubnetworkIamBindingKind)
)
