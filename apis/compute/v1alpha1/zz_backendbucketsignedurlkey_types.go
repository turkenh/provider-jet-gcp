...
var (
	BackendBucketSignedUrlKeyKind             = "BackendBucketSignedUrlKey"
	BackendBucketSignedUrlKeyGroupKind        = schema.GroupKind{Group: Group, Kind: BackendBucketSignedUrlKeyKind}.String()
	BackendBucketSignedUrlKeyKindAPIVersion   = BackendBucketSignedUrlKeyKind + "." + GroupVersion.String()
	BackendBucketSignedUrlKeyGroupVersionKind = GroupVersion.WithKind(BackendBucketSignedUrlKeyKind)
)
