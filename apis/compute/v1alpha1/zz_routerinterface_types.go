...
var (
	RouterInterfaceKind             = "RouterInterface"
	RouterInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: RouterInterfaceKind}.String()
	RouterInterfaceKindAPIVersion   = RouterInterfaceKind + "." + GroupVersion.String()
	RouterInterfaceGroupVersionKind = GroupVersion.WithKind(RouterInterfaceKind)
)
