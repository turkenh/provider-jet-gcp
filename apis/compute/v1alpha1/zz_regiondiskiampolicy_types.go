...
var (
	RegionDiskIamPolicyKind             = "RegionDiskIamPolicy"
	RegionDiskIamPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: RegionDiskIamPolicyKind}.String()
	RegionDiskIamPolicyKindAPIVersion   = RegionDiskIamPolicyKind + "." + GroupVersion.String()
	RegionDiskIamPolicyGroupVersionKind = GroupVersion.WithKind(RegionDiskIamPolicyKind)
)
