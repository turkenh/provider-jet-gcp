...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionSslCertificate
func (tr *RegionSslCertificate) GetTerraformResourceIDField() string {
	return "id"
}
