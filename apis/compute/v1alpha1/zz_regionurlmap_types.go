...
var (
	RegionUrlMapKind             = "RegionUrlMap"
	RegionUrlMapGroupKind        = schema.GroupKind{Group: Group, Kind: RegionUrlMapKind}.String()
	RegionUrlMapKindAPIVersion   = RegionUrlMapKind + "." + GroupVersion.String()
	RegionUrlMapGroupVersionKind = GroupVersion.WithKind(RegionUrlMapKind)
)
