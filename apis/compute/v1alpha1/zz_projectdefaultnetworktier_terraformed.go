...
// GetTerraformResourceIDField returns Terraform identifier field for this ProjectDefaultNetworkTier
func (tr *ProjectDefaultNetworkTier) GetTerraformResourceIDField() string {
	return "id"
}
