...
// GetTerraformResourceIDField returns Terraform identifier field for this SharedVpcServiceProject
func (tr *SharedVpcServiceProject) GetTerraformResourceIDField() string {
	return "id"
}
