...
type ComputeNetworkEndpointGroupObservation struct {
	SelfLink *string `json:"selfLink,omitempty" tf:"self_link,omitempty"`

	Size *int64 `json:"size,omitempty" tf:"size,omitempty"`
}

type ComputeNetworkEndpointGroupParameters struct {
...
type ComputeNetworkEndpointGroupSpec struct {
	...
	ForProvider     ComputeNetworkEndpointGroupParameters `json:"forProvider"`
}
...
type ComputeNetworkEndpointGroupStatus struct {
	...
	AtProvider        ComputeNetworkEndpointGroupObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// ComputeNetworkEndpointGroup is the Schema for the ComputeNetworkEndpointGroups API
...
type ComputeNetworkEndpointGroup struct {
	...
	Spec              ComputeNetworkEndpointGroupSpec   `json:"spec"`
	Status            ComputeNetworkEndpointGroupStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ComputeNetworkEndpointGroupList contains a list of ComputeNetworkEndpointGroups
...
var (
	ComputeNetworkEndpointGroupKind             = "ComputeNetworkEndpointGroup"
	ComputeNetworkEndpointGroupGroupKind        = schema.GroupKind{Group: Group, Kind: ComputeNetworkEndpointGroupKind}.String()
	ComputeNetworkEndpointGroupKindAPIVersion   = ComputeNetworkEndpointGroupKind + "." + GroupVersion.String()
	ComputeNetworkEndpointGroupGroupVersionKind = GroupVersion.WithKind(ComputeNetworkEndpointGroupKind)
)
