...
var (
	PacketMirroringKind             = "PacketMirroring"
	PacketMirroringGroupKind        = schema.GroupKind{Group: Group, Kind: PacketMirroringKind}.String()
	PacketMirroringKindAPIVersion   = PacketMirroringKind + "." + GroupVersion.String()
	PacketMirroringGroupVersionKind = GroupVersion.WithKind(PacketMirroringKind)
)
