...
// GetTerraformResourceIDField returns Terraform identifier field for this SubnetworkIamMember
func (tr *SubnetworkIamMember) GetTerraformResourceIDField() string {
	return "id"
}
