...
// GetTerraformResourceIDField returns Terraform identifier field for this DiskResourcePolicyAttachment
func (tr *DiskResourcePolicyAttachment) GetTerraformResourceIDField() string {
	return "id"
}
