...
var (
	FirewallPolicyAssociationKind             = "FirewallPolicyAssociation"
	FirewallPolicyAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: FirewallPolicyAssociationKind}.String()
	FirewallPolicyAssociationKindAPIVersion   = FirewallPolicyAssociationKind + "." + GroupVersion.String()
	FirewallPolicyAssociationGroupVersionKind = GroupVersion.WithKind(FirewallPolicyAssociationKind)
)
