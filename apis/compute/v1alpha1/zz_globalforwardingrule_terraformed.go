...
// GetTerraformResourceIDField returns Terraform identifier field for this GlobalForwardingRule
func (tr *GlobalForwardingRule) GetTerraformResourceIDField() string {
	return "id"
}
