...
var (
	PerInstanceConfigKind             = "PerInstanceConfig"
	PerInstanceConfigGroupKind        = schema.GroupKind{Group: Group, Kind: PerInstanceConfigKind}.String()
	PerInstanceConfigKindAPIVersion   = PerInstanceConfigKind + "." + GroupVersion.String()
	PerInstanceConfigGroupVersionKind = GroupVersion.WithKind(PerInstanceConfigKind)
)
