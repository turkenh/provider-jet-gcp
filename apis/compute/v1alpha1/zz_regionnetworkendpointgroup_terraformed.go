...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionNetworkEndpointGroup
func (tr *RegionNetworkEndpointGroup) GetTerraformResourceIDField() string {
	return "id"
}
