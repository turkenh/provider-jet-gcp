...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionDiskResourcePolicyAttachment
func (tr *RegionDiskResourcePolicyAttachment) GetTerraformResourceIDField() string {
	return "id"
}
