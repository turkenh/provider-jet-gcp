...
var (
	RegionDiskIamBindingKind             = "RegionDiskIamBinding"
	RegionDiskIamBindingGroupKind        = schema.GroupKind{Group: Group, Kind: RegionDiskIamBindingKind}.String()
	RegionDiskIamBindingKindAPIVersion   = RegionDiskIamBindingKind + "." + GroupVersion.String()
	RegionDiskIamBindingGroupVersionKind = GroupVersion.WithKind(RegionDiskIamBindingKind)
)
