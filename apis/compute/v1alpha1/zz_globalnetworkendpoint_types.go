...
var (
	GlobalNetworkEndpointKind             = "GlobalNetworkEndpoint"
	GlobalNetworkEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: GlobalNetworkEndpointKind}.String()
	GlobalNetworkEndpointKindAPIVersion   = GlobalNetworkEndpointKind + "." + GroupVersion.String()
	GlobalNetworkEndpointGroupVersionKind = GroupVersion.WithKind(GlobalNetworkEndpointKind)
)
