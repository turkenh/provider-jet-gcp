...
// GetTerraformResourceIDField returns Terraform identifier field for this RegionTargetHttpProxy
func (tr *RegionTargetHttpProxy) GetTerraformResourceIDField() string {
	return "id"
}
