...
var (
	InterconnectAttachmentKind             = "InterconnectAttachment"
	InterconnectAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: InterconnectAttachmentKind}.String()
	InterconnectAttachmentKindAPIVersion   = InterconnectAttachmentKind + "." + GroupVersion.String()
	InterconnectAttachmentGroupVersionKind = GroupVersion.WithKind(InterconnectAttachmentKind)
)
