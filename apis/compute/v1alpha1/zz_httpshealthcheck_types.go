...
var (
	HttpsHealthCheckKind             = "HttpsHealthCheck"
	HttpsHealthCheckGroupKind        = schema.GroupKind{Group: Group, Kind: HttpsHealthCheckKind}.String()
	HttpsHealthCheckKindAPIVersion   = HttpsHealthCheckKind + "." + GroupVersion.String()
	HttpsHealthCheckGroupVersionKind = GroupVersion.WithKind(HttpsHealthCheckKind)
)
