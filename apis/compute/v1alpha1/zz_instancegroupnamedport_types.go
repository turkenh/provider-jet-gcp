...
var (
	InstanceGroupNamedPortKind             = "InstanceGroupNamedPort"
	InstanceGroupNamedPortGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceGroupNamedPortKind}.String()
	InstanceGroupNamedPortKindAPIVersion   = InstanceGroupNamedPortKind + "." + GroupVersion.String()
	InstanceGroupNamedPortGroupVersionKind = GroupVersion.WithKind(InstanceGroupNamedPortKind)
)
