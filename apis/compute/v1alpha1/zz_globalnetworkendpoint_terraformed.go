...
// GetTerraformResourceIDField returns Terraform identifier field for this GlobalNetworkEndpoint
func (tr *GlobalNetworkEndpoint) GetTerraformResourceIDField() string {
	return "id"
}
