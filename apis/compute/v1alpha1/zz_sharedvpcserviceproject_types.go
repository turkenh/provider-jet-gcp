...
var (
	SharedVpcServiceProjectKind             = "SharedVpcServiceProject"
	SharedVpcServiceProjectGroupKind        = schema.GroupKind{Group: Group, Kind: SharedVpcServiceProjectKind}.String()
	SharedVpcServiceProjectKindAPIVersion   = SharedVpcServiceProjectKind + "." + GroupVersion.String()
	SharedVpcServiceProjectGroupVersionKind = GroupVersion.WithKind(SharedVpcServiceProjectKind)
)
