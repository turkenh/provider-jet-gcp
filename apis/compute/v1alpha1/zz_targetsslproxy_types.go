...
var (
	TargetSslProxyKind             = "TargetSslProxy"
	TargetSslProxyGroupKind        = schema.GroupKind{Group: Group, Kind: TargetSslProxyKind}.String()
	TargetSslProxyKindAPIVersion   = TargetSslProxyKind + "." + GroupVersion.String()
	TargetSslProxyGroupVersionKind = GroupVersion.WithKind(TargetSslProxyKind)
)
