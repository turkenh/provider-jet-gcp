...
// GetTerraformResourceIDField returns Terraform identifier field for this InstanceGroupNamedPort
func (tr *InstanceGroupNamedPort) GetTerraformResourceIDField() string {
	return "id"
}
