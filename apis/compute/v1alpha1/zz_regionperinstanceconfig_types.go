...
var (
	RegionPerInstanceConfigKind             = "RegionPerInstanceConfig"
	RegionPerInstanceConfigGroupKind        = schema.GroupKind{Group: Group, Kind: RegionPerInstanceConfigKind}.String()
	RegionPerInstanceConfigKindAPIVersion   = RegionPerInstanceConfigKind + "." + GroupVersion.String()
	RegionPerInstanceConfigGroupVersionKind = GroupVersion.WithKind(RegionPerInstanceConfigKind)
)
