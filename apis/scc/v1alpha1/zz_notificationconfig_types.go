...
var (
	NotificationConfigKind             = "NotificationConfig"
	NotificationConfigGroupKind        = schema.GroupKind{Group: Group, Kind: NotificationConfigKind}.String()
	NotificationConfigKindAPIVersion   = NotificationConfigKind + "." + GroupVersion.String()
	NotificationConfigGroupVersionKind = GroupVersion.WithKind(NotificationConfigKind)
)
