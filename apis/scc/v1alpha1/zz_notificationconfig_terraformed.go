...
// GetTerraformResourceIDField returns Terraform identifier field for this NotificationConfig
func (tr *NotificationConfig) GetTerraformResourceIDField() string {
	return "id"
}
