...
var (
	SourceKind             = "Source"
	SourceGroupKind        = schema.GroupKind{Group: Group, Kind: SourceKind}.String()
	SourceKindAPIVersion   = SourceKind + "." + GroupVersion.String()
	SourceGroupVersionKind = GroupVersion.WithKind(SourceKind)
)
