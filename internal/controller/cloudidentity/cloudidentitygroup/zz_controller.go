...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-gcp/apis/cloudidentity/v1alpha1"
)

// Setup adds a controller that reconciles CloudIdentityGroup managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	name := managed.ControllerName(v1alpha1.CloudIdentityGroupGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.CloudIdentityGroupGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.CloudIdentityGroup{}).
		Complete(r)
}
