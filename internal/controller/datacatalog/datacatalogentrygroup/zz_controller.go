...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-gcp/apis/datacatalog/v1alpha1"
)

// Setup adds a controller that reconciles DataCatalogEntryGroup managed resources.
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	name := managed.ControllerName(v1alpha1.DataCatalogEntryGroupGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.DataCatalogEntryGroupGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.DataCatalogEntryGroup{}).
		Complete(r)
}
